<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="kol.aspx.cs" Inherits="mobile_kol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <%--   <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        ...
        <iframe width="650" height="385" src="https://www.youtube.com/embed/V5IiTXh-Mxo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>--%>
      ...
      <div class="am-modal am-modal-no-btn" tabindex="-1" id="vmodal">
        <div class="am-modal-dialog">
            ...
            <div class="am-modal-bd am-g">
                <iframe class="youtube-player" type="text/html" width="500" height="300" src="https://www.youtube.com/embed/V5IiTXh-Mxo" frameborder="0"></iframe>
            </div>
        </div>
    </div>

    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto">
        <a data-am-modal="{target: '#vmodal', closeViaDimmer: 1, width: 650, height: 385}" style="cursor: pointer">
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180918/KOL_m.png" style="width: 100%">
        </a>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        ...
        <img alt="celebrities choice" src="https://www.hawooo.com/images/ftp/20180918/KOL_01M.png" style="float: left; display: block; width: 100%;" />
    </div>
                ...
                <ul style="height: 50%; list-style-type: none; margin: 0 4%; padding: 0;">
                    ...
                    <%--       <li class="am-fl box">
                        <a herf="#">
                            ...
                            <p class="discountpricem">RM<span style="font-size: medium; letter-spacing: -2px;">100.00</span><span class="am-fr deletepricem">省99.90</span></p>
                        </a></li>--%>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        ...
        <img alt="celebrities choice" src="https://www.hawooo.com/images/ftp/20180918/KOL_02M.png" style="float: left; display: block; width: 100%;" />
    </div>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        ...
        <img alt="celebrities choice" src="https://www.hawooo.com/images/ftp/20180918/KOL_03M.png" style="float: left; display: block; width: 100%;" />
    </div>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        ...
        <img alt="celebrities choice" src="https://www.hawooo.com/images/ftp/20180918/KOL_04M.png" style="float: left; display: block; width: 100%;" />
    </div>

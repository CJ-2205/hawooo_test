<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200811new_brands_best.aspx.cs" Inherits="mobile_static_200811new_brands_best" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #FFF3EE;">
        <div style="background: #000;">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200811/bbn_02m.png" + "?cacheVersion=" + cacheVersion %>' alt="main-banner" />
        </div>
...
<%--               <li>
                        <a href="200811new_brands_top.aspx">
                    ...
                    <li>
                        <a href="200811new_brands.aspx?#s4">
                            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200811/ss_04m.png" + "?cacheVersion=" + cacheVersion %>' alt="ss_04m" /></a>
                    </li>
                </ul>
            </div>
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="friendshipday.aspx.cs" Inherits="user_friendshipday" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; width: 999px; z-index: 1; margin: 0 auto">
           ...
           <a href="#" onclick="RedeemCoupon();">
  <%--      <div >--%>
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180724/friend/edm_01.png" alt="點我領折扣券" style="width: 100%">
      <%--      <a href="#" onclick="RedeemCoupon();"></a>
        </div>--%>
        </a>
        ...
        <a href="friendshipday.aspx?did=1">
            <img id="img1" src="https://www.hawooo.com/images/ftp/20180724/friend/edm_02.png" alt="寵愛媽咪" style="width: 25%; float: left;">
        </a>
        <a href="friendshipday.aspx?did=2">
            <img id="img2" src="https://www.hawooo.com/images/ftp/20180724/friend/edm_03.png" alt="寵愛媽咪" style="width: 25%; float: left;">
        </a>
        <a href="friendshipday.aspx?did=3">
            <img id="img3" src="https://www.hawooo.com/images/ftp/20180724/friend/edm_04.png" alt="寵愛媽咪" style="width: 25%; float: left;">
        </a>
        <a href="friendshipday.aspx?did=4">
            <img id="img4" src="https://www.hawooo.com/images/ftp/20180724/friend/edm_05.png" alt="寵愛媽咪" style="width: 25%; float: left;">
        </a>
        <div id="blockPl"></div>
        <!--
    ...
    <div style="width: 1000px; margin: 0 auto; background-color: #382789;">
        <div class="am-g sale1">
            <div id="div2" style="padding: 0 0px; float: left; width: 100%;">
                <ul class="am-avg-sm-4 " style="padding: 2px">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li class="am-fl hvr-float" style="width: 23%; background-color: #382789; padding: 2px; margin: 1% 1%;">

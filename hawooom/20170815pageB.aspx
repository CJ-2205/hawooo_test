<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="20170815pageB.aspx.cs" Inherits="mobile_20170815pageB" %>
        ...
        <div class="am-show-md-up">
            <div class="fullBanner">
                <a href="" target="_blank">
                    <img src="https://www.hawooo.com/images/ftp/20170815/0815B_01.png" alt="A Buy1free1"></a>
            </div>
        </div>
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20170815/bm_01.png" alt="A Buy1free1">
            </div>
        </div>
                    ...
                    <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
                        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8909&cid=42" target="_blank">
                                <img alt="【婦潔VIGILL】私密沐浴露(日常潔淨) 220ml" src="https://www.hawooo.com/images/ftp/20170815/bm_03.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8847" target="_blank">
                                <img alt="【Miss Hana花娜小姐】柔潤無暇BC精華棒(防曬款) SPF50 PA++ 12g (2色可選)" src="https://www.hawooo.com/images/ftp/20170815/bm_04.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8834" target="_blank">
                                <img alt="BHK's 人氣美白凍齡組" src="https://www.hawooo.com/images/ftp/20170815/bm_05.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=9141" target="_blank">
                                <img alt="【Merdeka Sale國慶限定】Laler菈楽 日日輕控＆夜夜爆燃(30顆/盒)" src="https://www.hawooo.com/images/ftp/20170815/bm_06.png" style="float: left; display: block; width: 100%;" /></a></li>
                        </ul>
                    </div>
                </td>
            </tr>

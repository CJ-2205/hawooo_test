<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="MidYearSale.aspx.cs" Inherits="user_static_MidYearSale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: #AC3538;">
        <div class="banner-box">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_01.png" %>' alt="" style="width: 100%;" />
        </div>
        <div>
            <ul class="copy-coupon am-avg-sm-3">
                <li>
                    <a id="coupon1" data-clipboard-text="MID20" onclick="Clip('coupon1');">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/cp_01.png" %>' alt="coupon1" style="width: 100%;" />
                    </a>
                </li>
                <li>
                    <a id="coupon2" data-clipboard-text="MID35" onclick="Clip('coupon2');">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/cp_02.png" %>' alt="coupon2" style="width: 100%;" />
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/cp_03.png" %>' alt="coupon2" style="width: 100%;" />
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="am-container">
            <section class="am-padding-top-xs">
                <div class="banner-box">
                    <a href="BeautySkincare.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_02.png" %>' alt="Banner" style="width: 100%;" />
                    </a>
                </div>
                ...
                <div class="see-more-btn">
                    <a href="BeautySkincare.aspx">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_03.png" %>' alt="SeeMoreBtn" style="width: 100%;" />
                    </a>
                </div>
            </section>
            ...
            <section>
                <div class="banner-box">
                    <a href="#" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_04.png" %>' alt="Banner" style="width: 100%;" />
                    </a>
                </div>
            ...
            <section class="shop-now-block">
                <div class="shop-now-banner ">
                    <a href="#" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_05.png" %>'  alt="" style="width: 100%;" />
                    </a>
                </div>
                <%--    ========商品滑滑區塊========--%>
            ...
            <section>
                <div class="banner">
                    <a href="#" target="_blank">
                        <img  src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/bn_06.png" %>' alt="Recomended For You Banner" style="width: 100%;" />
                    </a>
                </div>
        ...
        <footer class="activity-method">
            <p class="activity-method-p am-margin-0 am-container">
                ...
                4. Coupon is APPLICABLE on Flagship Stores ( EXCLUDING BHK’s, Qmomo, Dr Morita, UNIQMAN, BeautyMaker, Hallmark & Health Beauty Wo)<br />

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20171111happysales.aspx.cs" Inherits="user_20171111happysales" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20171111happysales.aspx";
                }
            }
        }
         )
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; margin: 0 auto; float: center; display: block; max-width: 900px;">
        <ul style="float: left; margin: 0; list-style-type: none; font-size: 0; width: 100%; margin-bottom: -2px;">
            ...
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/20171111part2.aspx">
                <img alt="單身購物節11-10/11" src="https://www.hawooo.com/images/ftp/20171110/11timePC2_01.png" style="float: left; display: block; width: 20%;" /></a></li>

            <li style="margin: 0;">
                <img alt="11號限定" src="https://www.hawooo.com/images/ftp/20171110/11timePC2_02.png" style="float: left; display: block; width: 80%;" /></li>


            <li style="margin: 0;">
                <img alt="限時整點特賣會" src="https://www.hawooo.com/images/ftp/20171110/11timePC2_03.png" style="float: left; display: block; width: 100%;" /></li>
    ...
    <div class="invisible">
        ...
        <div class="box">
            ...
            <a href="https://www.hawooo.com/user/20171111part2.aspx">
            ...
            <a href="https://www.hawooo.com/user/shop.aspx?eid=276">
                <img src="https://www.hawooo.com/images/ftp/20171110/1110_pc-section_07.png" style="width: 100px" alt="送111購物金"></a>

            <a href="https://www.hawooo.com/user/20171110iphonerank.aspx">
                <img src="https://www.hawooo.com/images/ftp/20171110/1007_pc-section_04.png" style="width: 100px" alt="iPhoneX累積消費賽" class="twoyearbottom"></a>

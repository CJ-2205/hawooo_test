<%@ Page Language="C#" AutoEventWireup="true" CodeFile="180305memberday.aspx.cs" Inherits="_180305memberday" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; margin: 0 auto; display: block; width: 1000px;">
        ...
        <img alt="VIP" src="https://www.hawooo.com/images/ftp/20180305/edm_01.png" style="float: left; display: block; width: 100%;" />

        <img alt="一名訂單免費" src="https://www.hawooo.com/images/ftp/20180305/edm_02.png" style="float: left; display: block; width: 100%;" />
    ...
    <div style="width: 100%; margin: 0 auto; display: block; width: 1000px;">
        ...
        <img alt="Hawooo.com" src="https://www.hawooo.com/images/ftp/20180305/edm_03.png" style="float: left; display: block; width: 100%;" />
    </div>

...
public partial class user_static_2020CNY_beauty : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/2020CNY_beauty.aspx" + Request.Url.Query);

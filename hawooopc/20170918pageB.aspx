<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20170918pageB.aspx.cs" Inherits="user_20170918pageB" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20170918pageB.aspx";
                }
            }
        }
         )
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-show-md-up">
        <div class="fullBanner"><a href="" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20170918/Ha3.png" alt="A Buy1free1"></a></div>
    </div>
    <div class="am-show-sm">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20170918/Ha3_mb.png" alt="A Buy1free1"></div>
    </div>

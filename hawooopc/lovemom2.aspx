<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="lovemom2.aspx.cs" Inherits="user_lovemom2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--    <img id="gotop" src="https://www.hawooo.com/images/ftp/20180731/edm_01.png" alt="點我領折扣券" style="width: 100%">--%>

        <a href="#" onclick="RedeemCoupon();">
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180731/edm_01.png" alt="點我領折扣券" style="width: 100%"></a>
 <%--       <a href="lovemom.aspx?did=1">
    ...
    <div style="width: 1000px; margin: 0 auto; background-color: #3b3b3b;">
        <div class="am-g sale1">
            <div id="div2" style="padding: 0 0px; float: left; width: 100%;">
                <ul class="am-avg-sm-4 " style="padding: 2px">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li class="am-fl hvr-float" style="width: 23%; background-color: #3b3b3b; padding: 2px; margin: 1% 1%;">

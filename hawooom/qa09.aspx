<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="qa09.aspx.cs" Inherits="mobile_qa09" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 20px" id="zhPanel" runat="server">
        <section class="am-container member-margin">
            <div class="qa-wrapper">
                <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a>如何查詢出貨狀態？</h4>
                <hr style="margin: 0">
                ...
                <div class="qa-content">
                    ...
                    <h5 class="qa-step">‧<p class="qa-step-note">Track here → <a href="http://www.goodmaji.com/" target="_blank">http://www.goodmaji.com/</a></p>
                    </h5>
    ...
    <div style="margin-top: 20px" id="enPanel" runat="server">
         <section class="am-container member-margin">
      <div class="qa-wrapper">
        <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a> How to track my shipment?</h4>
		<hr style="margin:0">  
		  
        <div class="qa-content">
          
          <h5 class="qa-step">Method 1.)<p class="qa-step-title">Once the order status change “<b>ship out</b>”, click the tracking number to track your parcel.</p></h5>
          <h5 class="qa-step">Method 2.)<p class="qa-step-title">Copy the tracking code and track on website → <a href="http://www.goodmaji.com/" target="_blank">http://www.goodmaji.com/</a></p></h5>

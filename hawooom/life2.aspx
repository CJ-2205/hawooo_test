<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="life2.aspx.cs" Inherits="mobile_life2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;">
        ...
        <a href="#">
            <img alt="midterm sale" src="https://www.hawooo.com/images/ftp/20180918/life2m.png" style="float: left; display: block; width: 100%;" /></a>
    ...
    <!--第1塊-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title">Lingeires</h4>
    </div>
    ...
    <!--第2塊-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title">Bags & Shoes</h4>
    </div>
    ...
    <!--第3塊-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title">Hair style</h4>
    </div>

...
public partial class mobile_static_200803_88shopping : System.Web.UI.Page
{
    ...
    public void setOptions()
    {
        ...
        optionFlashSalePeriod6 = new Options()
        {
            ...
            periodEnd = SwitchServer<string>(serverType, "2020-08-08 23:59:59", "2020-08-05 23:54:00"),
        };
        optionFlashSalePeriod7 = new Options()
        {
            control = rpFlashSalePeriodShared,
            eventId = SwitchServer<int>(serverType, 1094, 798),
            take = SwitchServer<int>(serverType, 8, 4),
    ...
    {
        DateTime periodImgSwitch = Convert.ToDateTime( SwitchServer<string>(serverType, "2020-08-09 00:00:00", "2020-08-07 20:05:00") );
        if (DateTime.Now < periodImgSwitch)
        {
            panelImgBn01Period1.Visible = true;
            panelImgBn03Period1.Visible = true;
        ...
        } else
        {
            ...
            panelImgBn03Period2.Visible = true;

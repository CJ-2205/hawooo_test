...
public partial class user_static_200811new_brands : System.Web.UI.Page
{
    public string cacheVersion = "1";


    private int TopBrandsEventId = 1116; //real:1116
    private int BestSellersEventId = 1117; //real:1117
    private int BrandsEventId = 1118;  //real:1118
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                //Todo_viola
                Response.Redirect("../mobile/200811new_brands.aspx" + Request.Url.Query);
            }
            BindTopBrands();
            BindBestSellers();
            BindBrands();
    ...
    private void BindBrands()
    {
        if (BrandsEventId != 0)
        {
            ...
            //brands3
            if (dt.Select("B01=454").Length > 0) //TEST:310 //REAL:454
            {

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="sale2.aspx.cs" Inherits="sale2" %>
    ...
    <div>
        ...
        <div class="am-u-sm-centered" style="position: fixed; bottom: 0; left: 50%; max-width: 650px; text-align: center; transform: translate(-50%); z-index: 999;">
            <ul class="am-avg-sm-4 am-cf" style="list-style-type: none; padding: 0; margin: 0;">
                <li class="am-fl">
                    <a href="20171208M.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171207/sec_01.png" style="width: 100%;" alt="回活動主頁"></a></li>

                <li class="am-fl">
                    <a href="sale3.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171207/sec_03.png" style="width: 100%;" alt="聖誕禮物"></a></li>

                <li class="am-fl">
                    <a href="sale1.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171207/sec_04.png" style="width: 100%;" alt="買就送"></a></li>

                <li class="am-fl">
                    <a href="sale4.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171207/sec_02.png" style="width: 100%;" alt="回饋rm1500"></a></li>
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20171207/edmm_05.png" alt="買就送 最高省120"></div>
        </div>

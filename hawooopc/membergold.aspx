<%@ Page Title="" Language="C#" MasterPageFile="user.master" AutoEventWireup="true" CodeFile="membergold.aspx.cs" Inherits="usercode_membergold" %>
            ...
            <!-- 購物金可用標題 voucher-left-title start -->
                <section class="member-left-title">
                    <div class="voucher-left-title">
                        ...
                        <h4 class="txtRsc" data-id="m025">可用購物金</h4>
                    </div>
                </section>
                                    ...
                                    <tr>
                                        <td class="voucher-content">
                                            ...
                                            <asp:Literal ID="lit_AD02" runat="server" Text='<%# Convert.ToDateTime( Eval("AD02")).ToString("dd/MM/yyyy") %>'></asp:Literal>
                                             ...
                                             <p>
                                            <asp:Literal ID="lit_AD09" runat="server" Text='<%# "NOTE : "+ Eval("AD09") %>'></asp:Literal>
                                             </p>
                                        </td>

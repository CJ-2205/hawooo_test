<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="3rd_flashsale.aspx.cs" Inherits="mobile_3rd_flashsale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        <img alt="celebrities choice" src="https://www.hawooo.com/images/ftp/20180918/flashsale_m.png" style="float: left; display: block; width: 100%;" />
    </div>
    ...
    <!--第2塊-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title">Coming Soon</h4>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #C2BDC2">
        ...
        <div style="position: relative; max-width: 600px; margin: 0 auto;">
            ...
            <div id="div2" style="max-width: 600px; margin: 0 auto;">
                            ...
                            <li class="am-fl box">
                                <a href="product.aspx?id=<%# Eval("WP01") %>">
                                    ...
                                    <div style="display: inline; position: absolute; z-index: 52; top: 2px; bottom: 0; left: 0; right: 0;">
                                        ...
                                        <img class="circle" src="https://www.hawooo.com/images/ftp/20180918/cs.png" alt="coming soon" width="100%" />

                                    </div>

                                    <h4 class="pnamem">
                                        <asp:Literal ID="Literal3" runat="server" Text='<%# Eval("WP02") %>'></asp:Literal></h4>
                                    <p class="discountpricem">RM<span style="font-size: medium; letter-spacing: -2px;">
                                      ???</span>
                                        <span class="am-fr deletepricem">RM
                                          <%# PbClass.GetPrice(Eval("WPA10").ToString(),Application["mycashrate"].ToString()) %></span>
                                    </p>
                                    ...
                                    <div style="width: 100%; position: relative; z-index: 51; margin: 0 auto">
                                        ...
                                        <div class="barstyle1">
                                             <div class="w3-container bar-white w3-round-xlarge" style="width:0%; height: 26px; float: right;"></div>
                                        <%--    <div class="w3-container bar-white w3-round-xlarge" style="width: 100%; height: 26px; float: right;"></div>--%>


                                            <%--         <span class="burn-text2">限量<%# Eval("SCOUNT").ToString() %>件</span>--%>
                                            <span class="burn-text2">限量<%#  id2stock(Convert.ToInt32(Eval("WP01").ToString())) %>件</span>
                                        </div>
                                    </div>
    ...
    <!--第3塊-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title">Sold Out</h4>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #C2BDC2">
        ...
        <div style="position: relative; max-width: 600px; margin: 0 auto;">
            ...
            <div id="div3" style="max-width: 600px; margin: 0 auto;">
                        ...
                        <ItemTemplate>
                            ...
                            <li class="am-fl box">
                                ...
                                <div style="display: inline; position: absolute; z-index: 52; top: 2px; bottom: 0; left: 0; right: 0;">
                                    ...
                                    <img class="circle" src="https://www.hawooo.com/images/ftp/20180918/out2.png" alt="coming soon" width="100%" />
...
<%--                                    <div class="barstyle1">
                                        ...
                                        <span class="burn-text2">已售出<%#  id2stock(Convert.ToInt32(Eval("WP01").ToString()))%>件</span>
                                    </div>--%>
                                        ...
                                        <div class="barstyle1">
                                            ...
                                            <%--  <img class="go_bt" src="https://www.hawooo.com/images/ftp/20180918/burn2.png" alt="賣超過60%出現" style="position: absolute; top: -29%; margin: auto; width: 13%; right: 88%;">--%>
                                           <img class="go_bt" src="https://www.hawooo.com/images/ftp/20180918/burn2.png" style="position: absolute; top: -29%; margin: auto; width: 13%; right: 88%;"/>

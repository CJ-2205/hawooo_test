<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="20170815pageD.aspx.cs" Inherits="mobile_20170815pageD" %>
                    ...
                    <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
                        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8904" target="_blank">
                                <img alt="【婦潔VIGILL】私密高效美白凝露 30ml" src="https://www.hawooo.com/images/ftp/20170815/dm_03.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=7682" target="_blank">
                                <img alt="【Miss Hana花娜小姐】妝素顏透亮賴床霜 30ml" src="https://www.hawooo.com/images/ftp/20170815/dm_04.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8348" target="_blank">
                                <img alt="NEWART 水芹控油淨化精華 120ml" src="https://www.hawooo.com/images/ftp/20170815/dm_05.png" style="float: left; display: block; width: 100%;" /></a></li>

                            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=3615" target="_blank">
                                <img alt="Anden Hud 低腰三角褲 6入(隨機) Ｍ/L/XL" src="https://www.hawooo.com/images/ftp/20170815/dm_06.png" style="float: left; display: block; width: 100%;" /></a></li>
                        </ul>
                    </div>
                </td>
            </tr>

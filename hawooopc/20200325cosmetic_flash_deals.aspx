<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20200325cosmetic_flash_deals.aspx.cs" Inherits="user_static_20200325cosmetic_flash_deals" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg" id="top">
        <section class="am-container">
            <div class="am-text-center">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200325/bbn_02.png" %>' alt="bbn_02" style="width: 100%;" />
            </div>

            <div class="shop-block am-padding-sm bg1">
                <div class="am-padding-bottom coupon-1">

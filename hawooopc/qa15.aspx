<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa15.aspx.cs" Inherits="user_qa15" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">可否取消訂單呢？</h4>
                <div class="qa-main">
                    <table></table>
                    <p class="qa-step-title">訂單確認後，會直接跟台灣廠商採買，因此訂單一旦付款與確認完成是無法做任何退款與取消。</p>
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">How do I cancel my order?</h4>
                <div class="qa-main">
                    <h5 class="qa-step">‧<p class="qa-step-title-eng">The order that you have been confirmed and paid will not be cancelled, because we would direct purchase from Taiwan manufacturer.</p>
                    </h5>

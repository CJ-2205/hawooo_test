...
public partial class mobile_static_brand_list : System.Web.UI.Page
{
    ...
    public void BindLg()
    {
        ...
        {
            _filter.language = "en";
            litAll.Text = "All Brands";
            litFlagTitle.Text = "Flagship";
            litFlag.Text = "Flagship";
        }
        else if (lg.Equals(LangType.zh))
        {
            _filter.language = "zh";
            litAll.Text = "全部品牌";
            litFlagTitle.Text = "旗艦店";
            litFlag.Text = "旗艦店";
        }
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2020CNY_beauty.aspx.cs" Inherits="mobile_static_2020CNY_beauty" %>
    ...
    <div class="am-g  main-contain">
        <div class="am-container">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200110/bbn_03m.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>
            <div class="banner-box am-padding-lg">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200110/free_01m.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>
            <section>

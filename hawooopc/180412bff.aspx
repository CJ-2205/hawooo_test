<%@ Page Language="C#" AutoEventWireup="true" CodeFile="180412bff.aspx.cs" Inherits="_180412bff" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="gotop" style="width: 100%; position: relative; width: 1180px; z-index: 1; margin: 0 auto">
        <img src="https://www.hawooo.com/images/ftp/20180413/edm_01.png" alt="bhk滿額贈" style="width: 100%">
    </div>


    <div style="width: 100%; margin: 0 auto; float: center; display: block; max-width: 1180px; position: relative; z-index: 10;">
                    ...
                    <div style="padding: 0 50px 0 50px;">
                        <ul class="am-avg-sm-5">
                            ...
                            <asp:Repeater ID="rp_product_list_1" runat="server" ViewStateMode="Enabled">
                                <ItemTemplate>
                                    <li class="am-fl" style="width: calc(20% - 20px); background: white; padding: 10px; margin: 10px">

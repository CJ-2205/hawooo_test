<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200710supplement_buy1free1.aspx.cs" Inherits="mobile_static_200710supplement_buy1free1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #EFEFEF;">
        ...
        <div class="am-padding-horizontal-xs">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200710/bbn_01m.png" + "?cacheVersion=" + cacheVersion %>' alt="bn_02m" />
        </div>

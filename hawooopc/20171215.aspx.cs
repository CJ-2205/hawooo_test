...
public partial class _17_12_17_1215UrgentEDM_ne_20171215 : System.Web.UI.Page
{
    ...
    private void bindProduct1(int eid)
    {
        ...
        cmd.CommandText = CFacade.GetFac.GetWPFac.GetProductListSql2(null, qList, null, "ORDER BY WP27 DESC OFFSET 0 ROWS FETCH NEXT 4 ROWS ONLY", null, true);

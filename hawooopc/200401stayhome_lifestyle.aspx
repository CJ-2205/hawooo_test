<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200401stayhome_lifestyle.aspx.cs" Inherits="user_static_200401stayhome_lifestyle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain">
        <section class="am-container am-padding-vertical-lg bg1">
            <div>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200401/bnn_04.png" %>' alt="bnn_04" style="width: 100%;" />
            </div>
            <div>

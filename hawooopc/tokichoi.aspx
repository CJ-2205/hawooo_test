<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="tokichoi.aspx.cs" Inherits="user_tokichoi" %>
    ...
    <div class="am-container" style="background-color: #ffffff; width: 1000px">
        <div class="am-g" style="position: relative">
            ...
            <div style="position: relative;">
                <img id="imgM" src="https://www.hawooo.com/images/ftp/20180809/t_edm_01.png" runat="server" style="width: 100%" />
...
<%--        <div class="am-g am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth: 200, itemMargin: 5, slideshow: false,controlNav:false}">--%>
            ...
            <ul class="am-avg-sm-12 style1 am-slides">
                <li id="_1" name="select" style="width: 33.33%; float: left; display: block; margin: 0; border: 0">
                    <a href="tokichoi.aspx?did=1">
                        <img src="https://www.hawooo.com/images/ftp/20180809/t_iocn_01.png" draggable="false">
             <%--           <span>RM 39.90 up</span>--%>
                    </a>
                </li>
                <li id="_2" name="select" style="width: 33.33%; float: left; display: block; margin: 0; border: 0">
                    <a href="tokichoi.aspx?did=2">
                        <img src="https://www.hawooo.com/images/ftp/20180809/t_iocn_02.png" draggable="false">
                      <%--  <span>RM 45.90 up</span>--%>
                    </a>
                </li>
                <li id="_3" name="select" style="width: 33.33%; float: left; display: block; margin: 0; border: 0">
                    <a href="tokichoi.aspx?did=3">
                        <img src="https://www.hawooo.com/images/ftp/20180809/t_iocn_03.png" draggable="false">
                     <%--   <span>RM 59.90 up</span>--%>
                    </a>
                </li>
            </ul>
        </div>

...
public partial class user_static_200813hawooo_lab : System.Web.UI.Page
{
    private int HwLabEventId = 798;
    ...
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        ...
        if (DateTime.Now >= _time)
        {
            ...
            Response.Redirect("https://www.hawooo.com/user/index.aspx");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/200813hawooo_lab.aspx" + Request.Url.Query);

            DataTable dt = BindData(this.HwLabEventId);

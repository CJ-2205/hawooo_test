<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa31.aspx.cs" Inherits="user_qa31" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content-text">
                <h4 class="qa-height qa-maintitle">服務條款</h4>
                <div class="qa-main">
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Use Of The Site</h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">User Submissions</h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Order Acceptance And Pricing</h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Trademarks And Copyrights</h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Applicable Law And Jurisdiction </h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Arbitration</h4>
                    <p class="qa-text-eng">
                    ...
                    <h4 class="qa-subtitle-eng">Termination</h4>
                    <p class="qa-text-eng">
                    ...
                    <hr>
                    <h4 class="qa-subtitle-eng">Terms of Use</h4>
                    <h5 class="qa-step-eng">1. Interpretation</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>1.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">2. Basis of the Contract</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>2.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">3. Orders and Specifications</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>3.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">4. Orders and Specifications</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td></td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">5. Terms of Payment</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td></td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">6. Delivery/Performance</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>6.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">7. Risk and property of the Goods</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>7.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">8. Warranties and Remedies</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>8.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">9. Force Majeure</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>9.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">10. Insolvency of Buyer</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>10.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">11.  Notices</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td></td>
                                <td>Any notice required or permitted to be given by either party to the other under these Conditions shall be in writing addressed, if to HaWooo, to its registered office or principal place of business and if to the Buyer, to the address stipulated in the relevant offer to purchase.</td>
                            </tr>
                        </tbody>
                    </table>
                    <br>
                    <h5 class="qa-step-eng">12.  Liability</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>12.1</td>
                                <td>HaWooo shall accept liability to the Buyer for death or injury resulting from its own or that of its employees' negligence. Save as aforesaid, HaWooo’s liability under or in connection with the Contract shall be subject to the limitations set out in this Condition
                                </td>
                            </tr>
                            <tr>
                                <td>12.2</td>
                            ...
                            <tr>
                                <td>12.5</td>
                                <td>The remedies set out in Condition 8 are the Buyer’s sole and exclusive remedies for non-conformity of or defects in the Goods or Services and HaWooo’s liability for the same shall be limited in the manner specified in Condition
                                </td>
                            </tr>
                            <tr>
                                <td>12.6</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">13.  Termination</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>13.1</td>
                    ...
                    <br>
                    <h5 class="qa-step-eng">14.  General</h5>
                    <table class="qa-term">
                        <tbody>
                            <tr>
                                <td>14.1</td>
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content-text">
                <h4 class="qa-height qa-maintitle">Terms of Service</h4>
                <div class="qa-main">
                    <p class="qa-text-eng">
                        Welcome to the www.hawooo.com website (the "Site"). By accessing the Site, you confirm your understanding of the Terms and Conditions. If you do not agree to these Terms and Conditions of use, you shall not use this website. The Site reserves the right, to change, modify, add, or remove portions of these Terms and Conditions of use at any time. Changes will be effective when posted on the Site with no other notice provided. Please check these Terms and Conditions of use regularly for updates. Your continued use of the Site following the posting of changes to these Terms and Conditions of use constitutes your acceptance of those changes.
                    </p>

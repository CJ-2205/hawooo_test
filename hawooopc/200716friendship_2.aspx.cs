...
public partial class user_static_200716friendship_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200716friendship.aspx" + Request.Url.Query);
            }
    ...
    private void BindYMALData(List<DataTable> CatDts, int take = 0)
    {
        ...
        DataTable YMAL = FilterYMALData(CatDts);
    ...
    private DataTable FilterYMALData(List<DataTable> CatDts)
    {
        ...
        var YMALRaw = from dr in YMALFull.AsEnumerable()
                      ...
                      select dr;
        return YMALRaw.CopyToDataTable();
    }

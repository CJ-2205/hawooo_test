...
public partial class user_selevent : System.Web.UI.Page
{
    protected void Page_PreInit(object sender, EventArgs e)
    {
        ...
        if (Session["desktop"] == null)
        {
            if (ismobile)
            {
                Response.Redirect("../mobile/selevent.aspx" + Request.Url.Query);
    ...
    private void BindImg(int eid)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (sDR.Length > 0)
            {
                lit_event_img.Text = "<img src=\"../images/adimgs/" + dt.Rows[0]["SPI04"].ToString() + "\" style=\"padding-bottom:10px;width:1145px;\" />";
            }
        }
    }
    ...
    protected void lnk_get_coupon_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "login", "doLogin('selevent.aspx" + Request.Url.Query + "');", true);

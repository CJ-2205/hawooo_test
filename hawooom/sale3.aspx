<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="sale3.aspx.cs" Inherits="sale3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <link rel="stylesheet" href="assets/css/newyearmom.css">    
   ...
   <a href="20171208M.aspx" style="display: inline"><img src="https://www.hawooo.com/images/ftp/20171207/sec_01.png" style="width:100%;" alt="回活動主頁"></a></li>
      ...
      <li class="am-fl">
   <a href="sale1.aspx" style="display: inline"><img src="https://www.hawooo.com/images/ftp/20171207/sec_04.png" style="width:100%;" alt="買就送"></a></li>
  ...
  <div class="fullBanner"><img src="https://www.hawooo.com/images/ftp/20171207/edmm_08.png" alt="聖誕禮物 好禮好優惠"></div>
</div>
      <!--系統開始帶商品-->
        <!--下方商品-->
<div class="pageBoxRed">

...
public partial class mobile_static_200527_vip_secret_sale : System.Web.UI.Page {
    private int EventIdOfSuperDeals = 777;
    private int EventIdOfHighlightedBrand =  778;
    private int ProductAmountOfSuperDeals = 16;
    private int ProductAmountOfHighlightedBrand =  12;
    ...
    protected void Page_Load (object sender, EventArgs e) {
        if (!IsPostBack) {
            ...
            dt = GetDataDt (this.EventIdOfHighlightedBrand);
            take = dt.AsEnumerable ().Take(this.ProductAmountOfHighlightedBrand).CopyToDataTable ();
            ...
            // (Start) 之後 uncomment 這些，也要修改 method 名稱和 method 裡面的邏輯。
            // =====================================================================
            // BindProductOfSuperDeals(this.EventIdOfSuperDeals, this.ProductAmountOfHotDeal);
            ...
            // BindTop8ClassData(); // Repeater of 6 categories.
            // BindRandom15Data();
            // (End) 之後 uncomment 這些，也要修改 method 名稱和 method 裡面的邏輯。
            // =====================================================================
        }
    }

    ...
    <div class="desktop-content">
        <div class="am-g">
            ...
            <div class="am-u-sm-2 default-panel" style="width: 160px">
                <div class="left-box">
                    <h3 style="padding-bottom: 10px"><a href="brandlist.aspx" style="color: #ff6180">
                        <i class="am-icon-hand-pointer-o"></i>
                        <span class="txtRsc" data-id="bdl001">全部品牌</span></a></h3>
                    <h3 class="txtRsc" data-id="bdl002">品牌分類</h3>
                    <ul class="left-menu">
            ...
            <div class="am-u-sm-10 p-0">
                            ...
                            <div class="am-u-sm-6 brandBox" style="float: left">
                                ...
                                <ul class="am-avg-sm-3 da-thumbs brandProdBox">
                                    <asp:Repeater ID="rp_prodcut" runat="server">
                                        <ItemTemplate>
                                            <li>
                                                <div class="am-panel brandPanel" style="height: 245px">
                ...
                <div class="am-g">
                    <div class="am-u-sm-12">
                        <ul class="am-pagination am-pagination-centered" style="position: initial;">

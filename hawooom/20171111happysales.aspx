<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="20171111happysales.aspx.cs" Inherits="mobile_20171111happysales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-u-sm-centered" style="position: fixed; bottom: 0; left: 50%; max-width: 650px; text-align: center; transform: translate(-50%); z-index: 999;">
        <ul class="am-avg-sm-3 am-cf" style="list-style-type: none; padding: 0; margin: 0;">
            <li class="am-fl">
                <a href="https://www.hawooo.com/mobile/20171111part2.aspx" style="display: inline">
                    <img src="https://www.hawooo.com/images/ftp/20171110/sec-M_01.png" style="width: 100%;" alt="單身購物節"></a></li>

            <li class="am-fl">
                <a href="https://www.hawooo.com/mobile/20171110iphonerank.aspx" style="display: inline">
                    <img src="https://www.hawooo.com/images/ftp/20171110/sec-M_02.png" style="width: 100%;" alt="累積消費賽"></a></li>

            <li class="am-fl">
                <a href="https://www.hawooo.com/mobile/20171110cash.aspx" style="display: inline">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; float: center; display: block; max-width: 650px;">
        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
            <li style="margin: 0;"><a href="https://www.hawooo.com/mobile/20171111part2.aspx" target="_blank">
                <img alt="雙11單身購物節" src="https://www.hawooo.com/images/ftp/20171110/11timeM2_01.png" style="float: left; display: block; width: 25%;" /></a></li>

            <li style="margin: 0;">
                <img alt="10/11 限時特賣會" src="https://www.hawooo.com/images/ftp/20171110/11timeM2_02.png" style="float: left; display: block; width: 75%;" /></li>

            <li style="margin: 0;">
                <img alt="10/11 限時特賣會" src="https://www.hawooo.com/images/ftp/20171110/11timeM2_03.png" style="float: left; display: block; width: 100%;" /></li>

<%@ Page Title="" Language="C#" MasterPageFile="mobile.master" AutoEventWireup="true" CodeFile="memberorder_rev1.aspx.cs" Inherits="memberorder_rev1" %>
            ...
            <div class="am-tabs" id="member-order-tab-wrapper" class="member-order-tab-wrapper">
                ...
                <div class="am-tabs-bd" style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                    ...
                    <div class="am-tab-panel  member-order-shop-tab">
                        ...
                        <ul class="member-order-shop-list">
                            <asp:Repeater ID="rp_rv_pending" runat="server" OnItemDataBound="rp_order_list_ItemDataBound">
                                <ItemTemplate>
                                    <li class="order-list">
                                        <a href="#!" class="order-list-header">
                                            <div>

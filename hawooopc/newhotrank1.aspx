<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newhotrank1.aspx.cs" Inherits="_newhotrank" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; width: 1000px; z-index: 1; margin: 0 auto">
        <img id="gotop" src="https://www.hawooo.com/images/ftp/nhr-week1/edm_01.png" alt="排行榜" style="width: 100%">
        ...
        <asp:UpdatePanel ID="up_product_coupon" runat="server">
            <ContentTemplate>
                <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="https://www.hawooo.com/images/ftp/nhr-week1/new99.gif" CssClass="go_bt btnn" OnClick="CpnBtn_Click" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <!--第一塊-->
    <div style="width: 1000px; margin: 0 auto; background-color: #ee3e69;">
        <img id="gosale1" src="https://www.hawooo.com/images/ftp/nhr-week1/edm_02.png" alt="新品排行" style="width: 100%;">
    ...
    <div style="width: 100%; position: relative; width: 1000px; z-index: 5; margin: 0 auto">
        ...
        <img src="https://www.hawooo.com/images/ftp/nhr-week1/edm_04.png" alt="hawooo.com" style="width: 100%;">

        <a href="https://www.hawooo.com/user/helloday1.aspx?tid=gosale1" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/nhr-week1/edm_05.png" alt="hawooo.com" style="width: 333px; height: 281px; float: left;"></a>

        <a href="https://www.hawooo.com/user/helloday1.aspx?tid=gosale2" target="_blank">
            <img class="twoyearbottom" src="https://www.hawooo.com/images/ftp/nhr-week1/edm_06.png" alt="hawooo.com" style="width: 333px; height: 281px; float: left;"></a>

        <a href="https://www.hawooo.com/user/helloday1.aspx?tid=gosale3" target="_blank">
            <img class="twoyearbottom" src="https://www.hawooo.com/images/ftp/nhr-week1/edm_07.png" alt="hawooo.com" style="width: 334px; height: 281px; float: left;"></a>

    </div>

    <!--第二塊-->
    <div style="width: 1000px; margin: 0 auto; background-color: #840a53;">
        <img id="gosale2" src="https://www.hawooo.com/images/ftp/nhr-week1/edm_03.png" alt="更多新品" style="width: 100%;">
        <div class="am-cf sale1">

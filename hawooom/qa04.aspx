<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="qa04.aspx.cs" Inherits="mobile_qa04" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 20px" id="zhPanel" runat="server">
        <section class="am-container member-margin">
            <div class="qa-wrapper">
                <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a>如何查看Ha幣和購物金呢？</h4>
                <hr style="margin: 0">

                <div class="qa-content">

                    <h5 class="qa-step">‧<p class="qa-step-title">登入會員帳號後，可在「我的Ha幣」和「我的購物金」中查看目前Ha幣和購物金的餘額。</p>
                    </h5>
    ...
    <div style="margin-top: 20px" id="enPanel" runat="server">
        <section class="am-container member-margin">
            <div class="qa-wrapper">
                <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a>How can I check the Ha Coin and HaWooo shopping credit?</h4>
                <hr style="margin: 0">

                <div class="qa-content">

                    <h5 class="qa-step">‧<p class="qa-step-title">After log in, it will show the Ha Coin and HaWooo shopping credit at the left side.</p>
                    </h5>
                    <h5 class="qa-step">‧<p class="qa-step-title">Click the Ha Coin and HaWooo shopping credit, it will show the balance and the expired date of the Ha Coin in your account.</p>
                    </h5>

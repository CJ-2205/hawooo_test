...
public partial class mobile_static_20191111after_party : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            var take = dt.AsEnumerable().Take(6).CopyToDataTable();
            rptCatch.DataSource = take;
            rptCatch.DataBind();

            dt = BindData(797);
            var take2 = dt.AsEnumerable().Take(6).CopyToDataTable();

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="bk_fri_life_sale.aspx.cs" Inherits="user_static_bk_fir_life_sale" %>
    ...
    <div class="am-g pc-contain  main-contain" id="top">
        <section class="am-container">
            <div class="banner-box  am-text-center">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191127/bnn_04.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>

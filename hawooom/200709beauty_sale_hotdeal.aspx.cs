...
public partial class mobile_static_200709beauty_sale_hotdeal: System.Web.UI.Page
{
    public string cacheVersion = "5";

    private int HotDealEventId = 1041; //1041

    private string _stime = "2020-07-28 12:00:00";
    ...
    private void BindHotDeal()
    {
        if (HotDealEventId != 0)
        {
            ...
            {
                hotdeal_rp.DataSource = _productHotDeal;
                hotdeal_rp.DataBind();
            }

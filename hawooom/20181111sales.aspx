<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20181111sales.aspx.cs" Inherits="mobile_20181111sales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;">
        ...
        <a href="#">
            <img id="mainImg" src="https://www.hawooo.com/images/ftp/20181101/mb1f1_01.png" runat="server" style="float: left; display: block; width: 100%;" /></a>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="false">
        ...
        <!--第2塊-->
        <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
            <h4 class="edm_title">Skincare</h4>
        </div>
        ...
        <!--第3塊-->
        <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
            <h4 class="edm_title">Supplements</h4>
        </div>

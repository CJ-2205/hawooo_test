<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200618mys2_flash_sale.aspx.cs" Inherits="user_static_200618mys2_flash_sale" %>
    ...
    <div class="am-g main-contain" style="background: #A63B24;">
        ...
        <div class="side-bar">
            <ul>
                ...
                <li class="flash-sale-display">
                    <a href="#!">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_01.png?v=1" %>' alt="ss_01" /></a>
                </li>
                <li>
                    <a href="200618mys2_hot_deal.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_02.png?v=1" %>' alt="ss_02" /></a>
                </li>
                <li>
                    <a href="200618mys2_value_buy.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_03.png?v=1" %>' alt="ss_03" /></a>
                </li>
                <li>
        ...
        <div class="am-container am-margin-vertical-lg">
            <div>
                <img class="am-margin-bottom-xl" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/bbn_03.png?v=2" %>' alt="bbn_02" />
            </div>
            ...
            <%--Block2 (Start) ======================================================--%>
            <div class="am-margin-bottom-xl am-padding-sm shop-block" style="background: #D39929;">
                <ul class="am-avg-sm-4">

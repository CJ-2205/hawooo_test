<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="qa11.aspx.cs" Inherits="mobile_qa11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 20px" id="zhPanel" runat="server">
        <section class="am-container member-margin">
            <div class="qa-wrapper">
                <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a>如何加入會員？</h4>
                <hr style="margin: 0">

                <div class="qa-content">

                    <h5 class="qa-step">1‧)<p class="qa-step-title">點選上方選單「註冊/登入」。</p>
                    </h5>
                ...
                <a href="">
                    <div class="am-g am-g-collapse" style="margin: .4em 0">
                        ...
                        <div class="am-u-sm-11">
                            <p class="qa-wantmore-text" style="text-align: left">
                                <b>Phone</b><br>
                                +603-23866096
                            </p>
    ...
    <div style="margin-top: 20px" id="enPanel" runat="server">
        <section class="am-container member-margin">
            <div class="qa-wrapper">
                <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a>How to register an account?</h4>
                <hr style="margin: 0">

                <div class="qa-content">

                    <h5 class="qa-step">1‧)<p class="qa-step-title">Click the "Register" button on the upper right corner.</p>
                    </h5>

                    <h5 class="qa-step">2‧)<p class="qa-step-title">Fill up your username, password and your email, and click yes the term of condition for membership.</p>
                    </h5>

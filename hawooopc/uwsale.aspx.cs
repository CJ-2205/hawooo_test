...
public partial class user_uwsale : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ...
                    string url = "location.href='../mobile/uwsale.aspx" + get+"'";
    ...
    private void bindDT()
    {
        ...
        switch (did)
        {
            case 1: //限量超值組合
                {
                    ...
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=514) ";
            ...
            case 2: //戴美妝旅行去
                {
                    //lit_title.Text = "保健食品 ";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=515) ";
                    //imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week2/edm_01.png";
            ...
            case 3: //帶禮物回家去
                {
                    //lit_title.Text = "美體保養";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=516) ";
                    //imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week2/edm_01.png";
            ...
            case 4: //帶禮物回家去
                {
                    //lit_title.Text = "美體保養";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=517) ";
                    //imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week2/edm_01.png";
                    //hrefM.HRef = "https://www.hawooo.com/mobile/search.aspx?stxt=KiKi%E6%8B%8C%E9%BA%B5";
                    break;
                }

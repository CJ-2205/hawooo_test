...
public partial class user_20181111rank : System.Web.UI.Page
{
    private string sdate = "2018-01-01 00:00:00";
    private string edate = "2018-01-12 00:00:00";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "location.href='../mobile/20181111rank.aspx'", true);
                }
            }
            ...
            dicNote.Add(0, "马来西亚飞台北双人来回机票 (一人中奖，二人同行，市值RM2,500)");
    ...
    public Tuple<DataTable, DateTime> GetRankDt()
    {
        ...
        else
        {
            ...
            cmd.CommandText = @"SELECT TOP 15
                                ...
                                WHERE ORM24>=0 AND ORM03>=@ST AND ORM03 <@ET AND ORM17 NOT LIKE '%hawoo%' 
                                GROUP BY ORM23
            ...
            Cache.Insert("RankDt", Rank, null, time.AddMinutes(5), TimeSpan.Zero);
            return Rank;
        }
    }

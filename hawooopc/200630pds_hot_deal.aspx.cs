...
public partial class user_static_200630pds_hot_deal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200630pds_hot_deal.aspx" + Request.Url.Query);
            }
            ...
            //BindProduct(productHotDeal, 1017, 0);
            //BindTop8ClassData();
        }
    }
    public void setDics ()

...
public partial class user_static_200401stay_home_shop : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/200401stay_home_shop.aspx" + Request.Url.Query);
    ...
    WHERE WP.WP05 = 1
     ...
     FROM
       ...
       FROM wp
       WHERE B01 IN(307, 235, 283, 72, 345, 334, 301, 309)
         AND WP07 = 1
         AND GETDATE()
         BETWEEN WP09
         AND WP10) AS DT

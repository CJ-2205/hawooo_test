<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2020valentines_day_hot_deal.aspx.cs" Inherits="user_static_2020valentines_day_hot_deal" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg">
        <section class="am-container">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200204/bbn_01.png" %>' alt="bbn_01" style="width: 100%;" />
            </div>

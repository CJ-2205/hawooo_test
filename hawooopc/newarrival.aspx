<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="newarrival.aspx.cs" Inherits="user_newarrival" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="banner-box" style="max-width: 1180px; margin: 0 auto;">
        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/201909192/bn_01.png" %>' alt="" style="width: 100%;" />
        <div class="timer pc-timer">
            <span id='d'></span>:
            <span id='h'></span>:
            <span id='m'></span>:
            <span id='s'></span>
    ...
    <div class="am-container pc-container" style="background-color: #EFE6E6;">
                ...
                <asp:Repeater ID="rp_top_products" runat="server">
                    <ItemTemplate>
                        <li class="am-fl  hvr-float">
                            <div class="resize">
                                <a href="<%# PbClass.DpUrl(Eval("WP01").ToString(),Eval("B01").ToString(),Eval("WP23").ToString()) %>" class="am-u-sm-12" style="background-color: #fff">
                                    ...
                                    <div class="product-right-box  am-u-sm-5  pc-product-right-box">
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name pc-product-name"><%# Eval("WP02").ToString() %> </h3>
                                            ...
                                            <div class="price-box pc-price-box">
                                                <h1 class="  pc-product-price">RM<%# Eval("WPA06").ToString() %>
                                                </h1>
                                                <div class="original-price pc-original-price">RM<%# Eval("WPA10").ToString() %></div>
                                            </div>

                                            <div class="below-block">
                                                <h6 class="sale-off  pc-sale-off "><%# Eval("PERSENT").ToString() %></h6>

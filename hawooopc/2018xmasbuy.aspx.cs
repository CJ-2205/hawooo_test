...
public partial class user_2018xmasbuy : System.Web.UI.Page
{
    private int did = 1;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "location.href='../mobile/2018xmasbuy.aspx'", true);
                }
            }
            ...
            switch (did)
            {
                case 1:
                    {
                        listId.Add(597);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181129/package_02.png";
                        break;
                    }
                case 2:
                    {
                        listId.Add(598);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181129/b1.png";
                ...
                case 3:
                    {
                        listId.Add(599);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181129/b2.png";
                        break;
                    }
                case 4:
                    {
                        listId.Add(600);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181129/b3.png";
                        break;
                    }
                case 5:
                    {
                        listId.Add(601);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181129/b4.png";
                        break;
                    }
            }
            bindDT(listId);

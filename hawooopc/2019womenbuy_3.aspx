...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- 小選單掰掰-->
    <div style="width: 1180px; margin: 0 auto; position: relative; background-color: #FF9796">
        <!--限時商品 倒數計時結束-->
        <!--限時商品 帶商品吧-->
        <a href="#" id="coupon1" data-clipboard-text="BEAUTY15" onclick="Clip('coupon1');">
            <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/bn_01.png" %>' style="margin: 0 auto; width: 100%" /></a>

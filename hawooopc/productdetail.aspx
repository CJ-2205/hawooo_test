<%@ Page Title="" Language="C#" MasterPageFile="user.master" AutoEventWireup="true"
    CodeFile="productdetail.aspx.cs" Inherits="user_productdetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <!--  引用Hawooo的Comment Js-->
    <script async src="http://rvtest.hawoo.com/js/Review.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="margin-top: 120px; display: block;">
        ...
        <asp:HiddenField ID="hf_BNAME" runat="server" EnableViewState="false" />
                    ...
                    <div class="product-details-content">
                        ...
                        <section class="product-spec-qty" style="min-width: 350px">
                            ...
                            <div class="am-g" style="padding-top: 5px;" id="panel_coupon" runat="server">
                                <div class="am-u-sm-1 product-spec-qty-titile">
                                    <span class="txtRsc">Coupon：</span>
                                </div>
                                <div class="am-u-sm-11 p-0 coupon-item" style="min-width: 200px; padding-left: 10px;">
                            ...
                            <asp:UpdatePanel ID="up_cart" runat="server">
                                <ContentTemplate>
                                    <ul class="p-0 m-0 am-cf">
                                        ...
                                        <li class="am-fl">
                                            <asp:LinkButton ID="lnk_preorder" runat="server" OnClick="lnk_preorder_OnClick" CssClass="product-button buy-now-btn uppercase" Visible="false"><i class="am-icon-plus"></i>PRE ORDER</asp:LinkButton>
                ...
                <div class="am-u-sm-3 ">
                    ...
                    <script>
                        function GetHwCommentRight(gid, oid) {
                            $("#hw-review-right").load("http://rvtest.hawoo.com/ReviewTemplate?Token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbGllbnRfaWQiOiJ0ZGlKc2s1enlqenZSbTgiLCJuYW1lIjoid1UzMW00NWlxVE5VM0RxIiwiaWQiOiI4MzM2MWZhYS00NWUxLTQ4Y2UtOWMzZi1hN2UxNzA3MGEwNjQiLCJuYmYiOjE1ODUxMjg0OTksImV4cCI6MTkwMDY2MTI5OSwiaWF0IjoxNTg1MTI4NDk5fQ.IywAucwVYHRpMOEgakt_Xb9kD3SINxO31jSm4gNf77c&GroupId=" + gid + "&ProductId=" + oid + "&Type=1&PerPage=2");
                        };
                    </script>
                </div>
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <script>
                            function GetHwComment(gid, oid) {
                                $("#hw-review").load("http://rvtest.hawoo.com/ReviewTemplate?Token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbGllbnRfaWQiOiJ0ZGlKc2s1enlqenZSbTgiLCJuYW1lIjoid1UzMW00NWlxVE5VM0RxIiwiaWQiOiI4MzM2MWZhYS00NWUxLTQ4Y2UtOWMzZi1hN2UxNzA3MGEwNjQiLCJuYmYiOjE1ODUxMjg0OTksImV4cCI6MTkwMDY2MTI5OSwiaWF0IjoxNTg1MTI4NDk5fQ.IywAucwVYHRpMOEgakt_Xb9kD3SINxO31jSm4gNf77c&GroupId=" + gid + "&ProductId=" + oid + "&Type=2&PerPage=10");
                            };
                        </script>
                        <!--  Hawooo Comment end-->

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qat03.aspx.cs" Inherits="user_qat03" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">Payments</h4>
                <div class="qa-index">
                    <ul>
                        <li class="qa-text-index-title"><a href="qa13.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            What are the payment methods available?</a></li>
                        <li class="qa-text-index-title"><a href="qa06.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            How to repay my order, if I have yet to pay it？</a></li>

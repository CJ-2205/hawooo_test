...
public partial class user_static_20200317life_style_festival : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/20200317life_style_festival.aspx" + Request.Url.Query);

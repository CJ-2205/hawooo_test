...
public partial class mobile_20181111 : System.Web.UI.Page
{
    ...
    private void bindDT()
    {
        ...
        searchProp.JoinTxts.Add("INNER JOIN (SELECT SPD01 AS SPD01,SPD02 AS SPD02,SPD05 FROM SPRODUCTSD WHERE SPD01 IN (566,567,568,569,570,571,572) ) AS DT ON  WP01=DT.SPD02  ");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newhotrank1.aspx.cs" Inherits="_newhotrank" MasterPageFile="~/mobile/mobile.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto">
        <img id="gotop" src="https://www.hawooo.com/images/ftp/nhr-week1/edmm_01.png" alt="新品排行" style="width: 100%">
        <asp:UpdatePanel ID="up_product_coupon" runat="server">
            <ContentTemplate>
                <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
                    <asp:ImageButton ID="ImageButton1" runat="server" CssClass="btnn" ImageUrl="https://www.hawooo.com/images/ftp/20180525/new99.gif" OnClick="CpnBtn_Click" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        <img id="gosale1" alt="新品排行" src="https://www.hawooo.com/images/ftp/nhr-week1/edmm_02.png" style="float: left; display: block; width: 100%;" />
    </div>
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #ee3e69">
        <div style="position: relative; max-width: 650px; margin: 0 auto;">
            <ul style="height: 50%; list-style-type: none; margin: 0 4%; padding: 0; background-color: #ee3e69">
    ...
    <!--第二塊開始-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        <img id="gosale2" alt="更多新品" src="https://www.hawooo.com/images/ftp/nhr-week1/edmm_03.png" style="float: left; display: block; width: 100%;" />
    </div>
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #ee3e69">
        <div style="position: relative; max-width: 650px; margin: 0 auto;">

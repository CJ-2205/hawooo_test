<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200618mys2_flash_sale.aspx.cs" Inherits="mobile_static_200618mys2_flash_sale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #A63B24;">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/bbn_03m.png?v=1" %>' alt="main-banner" />
        </div>

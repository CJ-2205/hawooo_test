<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200401stayhome_lifestyle.aspx.cs" Inherits="mobile_static_200401stayhome_lifestyle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain">
        <div class="am-container">
            <div>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200401/bnn_04m.png" %>' alt="bnn_04m" style="width: 100%;" />
            </div>
            <%--========================Coupon Start===============================--%>
            <div>

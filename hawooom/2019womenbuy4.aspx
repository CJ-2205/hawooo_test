<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2019womenbuy4.aspx.cs" Inherits="mobile_2019womenbuy4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!--edm開始-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #FFE7BC; position: relative">
        <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/fbn_01m.png" %>' style="float: left; display: block; width: 100%;" /></a>

        <ul class="am-avg-sm-2">
            <li>
                <a id="coupon1" data-clipboard-text="FOOD5" onclick="Clip('coupon1');">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_01m.png"%>' alt="coupon1" style="width: 100%;" />
                </a>
            </li>
            <li>
                <a id="coupon2" data-clipboard-text="FOOD10" onclick="Clip('coupon2');">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_02m.png"%>' alt="coupon2" style="width: 100%;" />
                </a>
            </li>
            <%--<li>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_03m.png"%>' alt="coupon3" style="width: 100%;" />
            </li>--%>
        </ul>
    </div>
    ...
    <!--第0塊商品-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #FFE7BC" id="bc">

        

        <ul class="am-tabs-nav am-nav am-nav-tabs am-nav-justify">
            <li id="tab1">
                <a href="2019womenbuy4.aspx?did=1">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/ficon_01.png" %>' width="100%" />
                </a>

            </li>
            <li id="tab2">
                <a href="2019womenbuy4.aspx?did=2">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/ficon_02.png" %>' width="100%" />
                </a>

            </li>
            <li id="tab3">
                <a href="2019womenbuy4.aspx?did=3">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/ficon_03.png" %>' width="100%" />
                </a>

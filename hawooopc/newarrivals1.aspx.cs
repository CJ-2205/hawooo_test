...
public partial class user_newarrivals1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "location.href='../mobile/newarrivals1.aspx'", true);
                }
            }
    ...
    //        case 1: //新品排行Top10
    //            {
    //                //lit_title.Text = "新品排行Top10";
    //                sb.Append("AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=362) ");
    //                imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_01.png";
    //                break;
    //            }
    //        case 2: //VIVI PAM
    //            {
    ...
    //                imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_02.png";
    //                hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=ElaineSun";
    //                break;
    //            }
    //        case 3: //IVYMAISON
    //            {
    ...
    //                imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_03.png";
    //                hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=Aurora";
    //                break;
    //            }
    //        case 4: //健康力
    //            {
    ...
    //                imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_04.png";
    //                hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=執覺手作拌麵";
    //                break;
    //            }
    //        case 5: //新品排行Top40
    //            {
    //                //lit_title.Text = "新品排行Top40";
    ...
    private void bindDT()
    {
        ...
        switch (did)
        {
            case 1: //限量超值組合
                {
                    ...
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=362) ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_01.png";
                    b = false;
                    break;
                }
            case 2: //戴美妝旅行去
                {
                    //lit_title.Text = "保健食品 ";
                    strCmd = "AND WPC03=43 AND DATEDIFF(DAY,WP11,GETDATE())<=100 AND  GETDATE()>=WP09 AND GETDATE()<WP10  ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_01.png";
            ...
            case 7:
                {
                    //lit_title.Text = "品味美食";
                    strCmd = "AND WPC03=47  AND DATEDIFF(DAY,WP11,GETDATE())<=100 AND  GETDATE()>=WP09 AND GETDATE()<WP10  ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_01.png";
                    break;
                }
            case 8:
                {
                    ...
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=338) ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_02.png";
                    hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=ElaineSun";
                    b = false;
                    break;
            ...
            case 9:
                {
                    //lit_title.Text = "齒妍堂";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=340) ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_03.png";
                    hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=Aurora";
                    b = false;
                    break;
            ...
            case 10:
                {
                    //lit_title.Text = "愛上新鮮";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=370) ";
                    imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week1/edm_04.png";
                    hrefM.HRef = "https://www.hawooo.com/user/search.aspx?stxt=執覺手作拌麵";
                    b = false;
                    break;
    ...
    //    getProductCoupon("0d2726e4-c3a9-4a50-bff1-d1caef5ce2ff");
    //}

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20170824samePrice.aspx.cs" Inherits="mobile_20170824samePrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        $(function () {
            ...
            if (b == false) {
                window.location.href = "https://www.hawooo.com/user/shop.aspx?eid=183"
            }
    ...
    <div style="margin-top: 120px">
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20170824/edmm_01.png" alt="台馬同步售價">
            </div>
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="wordcupsales2.aspx.cs" Inherits="user_wordcupsales2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%-- <div style="width: 100%; position: relative; width: 900px; z-index: 1; margin: 0 auto">
        ...
        <img id="gotop" src="https://www.hawooo.com/images/ftp/20180629/pro/edm_01.png" alt="年中慶part2" style="width: 100%">
        ...
        <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
            ...
            <a href="https://www.hawooo.com/user/WorldCupSpin.aspx" target="_blank">
                <img class="go_bt" src="https://www.hawooo.com/images/ftp/20180620/32/btn_01.png" alt="足球賽" style="position: absolute; top: 78%; margin: auto; width: 75%; left: 8%;" />
            </a>

            <a href="https://www.hawooo.com/user/18worldcup.aspx" target="_blank">
                <img class="go_bt" src="https://www.hawooo.com/images/ftp/20180620/pro/btn_03.png" alt="拿獎金" style="position: absolute; top: 78%; margin: auto; width: 75%; left: 72%;" />
            </a>
    ...
    <div style="width: 100%; position: relative; width: 900px; z-index: 1; margin: 0 auto">
        <div class="btnnn btnnss" data-clipboard-text="Worldcup20"></div>
        <img id="gotop0" src="https://www.hawooo.com/images/ftp/20180706/pro/edm_01.png" alt="年中慶part2" style="width: 100%">
    ...
    <div style="width: 900px; margin: 0 auto; background-color: #000b04;">
        <img id="gosale1" src="https://www.hawooo.com/images/ftp/20180629/pro/edm_02.png" alt="熬夜看足球" style="width: 100%; float: left;">
        ...
        <a href="https://www.hawooo.com/user/market.aspx?cid=48" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/01.png" alt="生活看更多" style="width: 300px; float: left;"></a>

        <a href="https://www.hawooo.com/user/market.aspx?cid=43" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/02.png" alt="保健看更多" style="width: 300px; float: left;"></a>

        <a href="https://www.hawooo.com/user/market.aspx?cid=47" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/03.png" alt="美食看更多" style="width: 300px; float: left;"></a>
    ...
    <!--第二塊-->
    <div style="width: 900px; margin: 0 auto; background-color: #000b04;">
        <img id="gosale2" src="https://www.hawooo.com/images/ftp/20180629/pro/edm_07.png" alt="自然系美女" style="width: 100%; float: left;">


        <div class="am-g sale2">
        ...
        <a href="https://www.hawooo.com/user/market.aspx?cid=42" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/04.png" alt="保養看更多" style="width: 50%; float: left;"></a>

        <a href="https://www.hawooo.com/user/market.aspx?cid=16" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/05.png" alt="美妝看更多" style="width: 50%; float: left;"></a>
    ...
    <div style="width: 900px; margin: 0 auto; background-color: #000b04;">
        <img id="gosale3" src="https://www.hawooo.com/images/ftp/20180629/pro/edm_11.png" alt="運動風混搭" style="width: 100%; float: left;">


        <div class="am-g sale3">
    ...
    <div style="width: 900px; margin: 0 auto; position: relative; z-index: 10;">
        ...
        <a href="https://www.hawooo.com/user/market.aspx?cid=44" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/06.png" alt="內衣看更多" style="width: 300px; float: left;"></a>

        <a href="https://www.hawooo.com/user/market.aspx?cid=46" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/07.png" alt="包包看更多" style="width: 300px; float: left;"></a>

        <a href="https://www.hawooo.com/user/market.aspx?cid=45" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20180629/pro/08.png" alt="鞋子看更多" style="width: 300px; float: left;"></a>
    ...
    <div class="invisible" style="z-index: 50;">
        <!-- box是固定的nav-->
        <div class="box">
            <a href="javascript:void(0)" onclick="GoID('gotop0')">

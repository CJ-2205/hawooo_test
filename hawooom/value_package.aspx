<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="value_package.aspx.cs" Inherits="mobile_static_value_package" %>
    ...
    <div class="am-g  main-contain">
        <div class="am-container am-padding-vertical-lg">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191111/bbn_03m.png" %>' alt="" style="width: 100%;" />
            </div>

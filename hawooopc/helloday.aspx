<%@ Page Language="C#" AutoEventWireup="true" CodeFile="helloday.aspx.cs" Inherits="helloday" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 900px; margin: 0 auto;">
        <a href="https://www.hawooo.com/user/search.aspx?stxt=solone" target="_blank">
            <img id="gosale1" src="https://www.hawooo.com/images/ftp/week1/edm_01.png" alt="Dr.cink" style="width: 100%;"></a>
    </div>
    ...
    <div style="width: 900px; margin: 0 auto;">
        <a href="https://www.hawooo.com/user/search.aspx?stxt=%E9%9C%B2%E5%A5%87%E4%BA%9E" target="_blank">
            <img id="gosale2" src="https://www.hawooo.com/images/ftp/week1/edm_02.png" alt="台酒TTL" style="width: 100%;"></a>
    </div>
    ...
    <div style="width: 900px; margin: 0 auto;">
        <a href="https://www.hawooo.com/user/brands.aspx?bid=202" target="_blank">
            <img id="gosale3" src="https://www.hawooo.com/images/ftp/week1/edm_03.png" alt="嗜．香氛" style="width: 100%;"></a>
    </div>
    ...
    <div class="invisible" style="z-index: 13">
        ...
        <div class="box">
            ...
            <a href="javascript:void(0)" onclick="GoID('gosale1')">
                <img src="https://www.hawooo.com/images/ftp/20180409/sidebar_05.png" style="width: 150px; margin-bottom: -1px" alt="洗髮"></a>
        </div>
    </div>

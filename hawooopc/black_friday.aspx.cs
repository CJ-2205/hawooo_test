...
public partial class user_static_black_friday : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/black_friday.aspx" + Request.Url.Query);
 ...
 ORDER BY WP01 DESC";
    ...
    private void BindBrand()
    {
        ...
        List<BrandCs> list = new List<BrandCs>
        {
            ...
            new BrandCs(url + 433.ToString(), cm_a + "ftp/20191127/bd_07.png"),

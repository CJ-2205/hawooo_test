...
public partial class user_static_200811new_brands_best : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200811new_brands_best.aspx" + Request.Url.Query);
            }
    ...
    private void BindBestSellers()
    {
        if (BestSellersEventId != 0)
        {
            ...
            {
                bestseller_rp.DataSource = _productBestSellers;

...
public partial class mobile_static_2020valentines_day : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Repeater rp4 = products10.FindControl("rp_goods") as Repeater;
            rp4.DataSource = dt;
            rp4.DataBind();
...
END)";
    ...
    public DataTable GetGoods(LangType lg, string et = "")
    {
        ...
        sb.Append("INNER JOIN EVENT0121 AS T ON T.PID=WP01 ");
        sb.Append("WHERE NOT EXISTS");
        sb.Append("(SELECT SPD02 FROM SPRODUCTSD WHERE SPD01 IN (858,859) AND WP01=SPD02) ");

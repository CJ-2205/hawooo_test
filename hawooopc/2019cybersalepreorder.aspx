<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2019cybersalepreorder.aspx.cs" Inherits="user_2019cybersalepreorder" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-container" style="background-color: #dfdfdf; padding: 15px;">
        <div>
            <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20190927/bn_02.png" style="width: 100%" />
        </div>
        <%-- 上方加入商品 --%>
    ...
    <script>
        ...
        function DoDel(ItemID) {
            ...
            if (memberID !== '') {
                ...
                $.ajax({
                    type: "post",
                    url: "2019cybersalepreorder.aspx/DoDel",
                    data: val,
                ...
                doLogin("2019cybersalepreorder.aspx.aspx");
            }
        }
        ...
        function AddEvent(iid, pid, qty) {
            ...
            if (iid !== "") {
                ...
                $.ajax({
                    type: "post",
                    url: "2019cybersalepreorder.aspx/DoAdd",
                    data: val,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
        ...
        function BookingEvent(selectProduct) {
            ...
            if (memberID !== '') {
                ...
                doLogin("2019cybersalepreorder.aspx");
            }
        }
        ...
        function AddOneItem(itemID) {
            ...
            $.ajax({
                type: "post",
                url: "2019cybersalepreorder.aspx/GetItem",
                data: val,
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function GetList() {
            ...
            $.ajax({
                type: "post",
                url: "2019cybersalepreorder.aspx/GetAddList",
                data: LG,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,

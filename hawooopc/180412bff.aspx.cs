...
public partial class _180412bff : System.Web.UI.Page
{
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        ...
        if (isMobile)
        {
            ...
            Response.Redirect("../mobile/180412bff.aspx" + qstr);
        }
    }
    ...
    private void bindProduct1(int eid)
    {
        ...
        cmd.CommandText = GetProductListSql2(null, qList, null, "ORDER BY WP18 DESC ", null, true);

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="beautymakersales.aspx.cs" Inherits="mobile_beautymakersales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;">
        ...
        <a href="#">
            <img alt="midterm sale" src="https://www.hawooo.com/images/ftp/20180709/Bedmm_01.png" style="float: left; display: block; width: 100%;" /></a>
...
<%--    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto; margin-bottom: -1px;">
        ...
        <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
           ...
           <a href="#" id="hidimg2" visible="false" runat="server"><img src="https://www.hawooo.com/images/ftp/20180709/select2.png" alt="第2塊" style="position:absolute;top:0;margin:auto;width:50%;left:50%;"/></a>
				
				<a href="#" id="hidimg3" visible="false" runat="server"><img src="https://www.hawooo.com/images/ftp/20180709/select3.png" alt="第3塊" style="position:absolute;top:0;margin:auto;width:50%;left:101.5%;"/></a> 
    ...
    <div style="max-width: 650px; background-color: black; margin: 0 auto;">

        <div class="am-cf" style="max-width: 585px; background-color: black; margin: 0 auto;">

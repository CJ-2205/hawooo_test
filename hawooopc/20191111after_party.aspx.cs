...
public partial class user_static_20191111after_party : System.Web.UI.Page
{
...
WHERE WP.WP05 = 1
 ...
 ORDER BY WP01 DESC";
        ...
        {
            Repeater rptBrand1 = Brand1.FindControl("rp_goods") as Repeater;
            rptBrand1.DataSource = dt.Select("B01=208").CopyToDataTable();
            rptBrand1.DataBind();
        }

        if (dt.Select("B01=269").Length > 0)
        {
            Repeater rptBrand2 = Brand2.FindControl("rp_goods") as Repeater;
            rptBrand2.DataSource = dt.Select("B01=269").CopyToDataTable();
            rptBrand2.DataBind();
        }

        if (dt.Select("B01=312").Length > 0)
        {
            Repeater rptBrand3 = Brand3.FindControl("rp_goods") as Repeater;
            rptBrand3.DataSource = dt.Select("B01=312").CopyToDataTable();
            rptBrand3.DataBind();
        }

        if (dt.Select("B01=283").Length > 0)
        {
            Repeater rptBrand4 = Brand4.FindControl("rp_goods") as Repeater;
    ...
    private void BindBrand()
    {
        ...
        {
            new BrandCs(url + 299.ToString(), cm_a + "ftp/20191112/bd_05.png"),
            new BrandCs(url + 72.ToString(), cm_a + "ftp/20191112/bd_06.png"),
            new BrandCs(url + 235.ToString(), cm_a + "ftp/20191112/bd_07.png"),
            new BrandCs(url + 318.ToString(), cm_a + "ftp/20191112/bd_08.png"),
            new BrandCs(url + 229.ToString(), cm_a + "ftp/20191112/bd_09.png"),
            new BrandCs(url + 301.ToString(), cm_a + "ftp/20191112/bd_10.png"),
            new BrandCs(url + 287.ToString(), cm_a + "ftp/20191112/bd_11.png"),
            new BrandCs(url + 321.ToString(), cm_a + "ftp/20191112/bd_12.png"),
        };

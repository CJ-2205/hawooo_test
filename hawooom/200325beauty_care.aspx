<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200325beauty_care.aspx.cs" Inherits="mobile_static_200325beauty_care" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g  main-contain">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200320/bnn_02m.png" %>' alt="bnn_02m" style="width: 100%;" />
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="qa08.aspx.cs" Inherits="mobile_qa08" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 20px" id="zhPanel" runat="server">
      ...
      <div class="qa-wrapper">
        <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a> 請問多久會收到商品？</h4>
		<hr style="margin:0">  
		  
        <div class="qa-content">
          
          <h5 class="qa-step"><p class="qa-step-title">訂單確認後，第二天算起：<br>『西馬』3-10 個工作天<br>『東馬』3-15 個工作天</p></h5>
          <h5 class="qa-step">‧<p class="qa-step-note">(備註：不包含週末和公共假期)</p></h5>
    ...
    <div style="margin-top: 20px" id="enPanel" runat="server">
        <section class="am-container member-margin">
      <div class="qa-wrapper">
        <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a> When will I receive my parcel?</h4>
		<hr style="margin:0">  
		  
        <div class="qa-content">
          
          <h5 class="qa-step">‧<p class="qa-step-title">After confirming you order, starting from the next day onward.West Malaysia within 3-10; East Malaysia within 3-15 working days.</p></h5>
          <h5 class="qa-step">‧<p class="qa-text-eng" style="display: inline">(Note: working days are excluded public holiday and weekend.)</p></h5>

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="bk_fri_most_popular.aspx.cs" Inherits="mobile_static_bk_fri_most_popular" %>
    ...
    <div class="am-g  main-contain">
        <div class="am-container">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "/ftp/20191127/bnn_02m.png"%>' alt="" style="width: 100%;" />
            </div>
            <section>
        ...
        <div class="footer-bar-block">
            ...
            <div class="footer-bar-point">
                <ul class="am-avg-sm-3">
                    ...
                    <li><a href="#!"></a></li>
                    <li><a href="bk_fri_beauty_sale.aspx" target="_blank"></a></li>

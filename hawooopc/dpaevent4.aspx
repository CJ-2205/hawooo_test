<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="dpaevent4.aspx.cs" Inherits="dpaevent4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-container" style="background-color: #ffffff; width: 1000px">
        <div class="am-g" style="position: relative">
            ...
            <img src="../images/ftp/dpa4/edm_01.png" width="100%" />
            ...
            <ul class="am-avg-sm-6 style1">
                <li>
                    <a href="dpaevent4.aspx?did=1">
                        <div style="position: relative;">
                            <img id="_1" src="../images/ftp/dpa4/dpa01.gif" style="width: 82%; margin: 0px 15px" />
                            <div id="d1">
                            </div>
                        </div>
                ...
                <li>
                    <a href="dpaevent4.aspx?did=2">
                        <div style="position: relative;">
                            <img id="_2" src="../images/ftp/dpa4/dpa02.png" style="width: 82%; margin: 0px 15px" />
                            <div id="d2">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent4.aspx?did=3">
                        <div style="position: relative;">
                            <img id="_3" src="../images/ftp/dpa4/dpa03.png" style="width: 82%; margin: 0px 15px" />
                            <div id="d3">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent4.aspx?did=4">
                        <div style="position: relative;">
                            <img id="_4" src="../images/ftp/dpa4/dpa04.png" style="width: 82%; margin: 0px 15px" />
                            <div id="d4">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent4.aspx?did=5">
                        <div style="position: relative;">
                            <img id="_5" src="../images/ftp/dpa4/dpa05.png" style="width: 82%; margin: 0px 15px" />
                            <div id="d5">
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="dpaevent4.aspx?did=6">
                        <div style="position: relative;">
                            <img id="_6" src="../images/ftp/dpa4/dpa06.png" style="width: 82%; margin: 0px 15px" />
                            <div id="d6">
                            </div>
                        </div>
                    </a>

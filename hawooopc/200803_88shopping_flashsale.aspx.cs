...
public partial class user_static_200803_88shopping_flashsale : System.Web.UI.Page
{
    ...
    public void setOptions()
    {
        optionFlashSalePeriod1 = new Options()
        {
            ...
            periodEnd = SwitchServer<string>(serverType, "2020-08-03 23:59:59", "2020-08-05 22:00:00"),
        ...
        optionFlashSalePeriod6 = new Options()
        {
            ...
            eventId = SwitchServer<int>(serverType, 1094, 798),
            take = SwitchServer<int>(serverType, 0, 2),
        ...
        optionFlashSalePeriod7 = new Options()
        {
            ...
            eventId = SwitchServer<int>(serverType, 1094, 798),
            take = SwitchServer<int>(serverType, 0, 1),
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200803_88shopping_flashsale.aspx" + Request.Url.Query);
            }

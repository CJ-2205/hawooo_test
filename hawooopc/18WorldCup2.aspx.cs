...
public partial class _18WorldCup2 : System.Web.UI.Page
{
    ...
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        ...
        if (isMobile)
        {
            ...
            Response.Redirect("../mobile/18WorldCup.aspx" + qstr);
        }
        else
        {
            if (Session["A01"] != null)
...
OM.ORM23=@ORM23 AND ORM03< CONVERT(DATETIME	,'2018-06-20 00:00:00' ) AND ORM19=1  GROUP BY ORM23 ) AS DT1
LEFT JOIN 
...
WHERE ORM03< CONVERT(DATETIME,'2018-06-20 00:00:00' ) AND ORM19=1 AND ORM23=@ORM23 
ORDER BY ORM03 DESC";

...
public partial class user_static_200709beauty_sale_hotdeal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200709beauty_sale_hotdeal.aspx" + Request.Url.Query);
            }
    ...
    public void setOptions()
    {
        ...
        optionHotDeal.Add("eventId", toggleSvr<int>(serverType, 1041, 777));
        optionHotDeal.Add("take", toggleSvr<int>(serverType, 0, 7));

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="2018xmaspreorder.aspx.cs" Inherits="mobile_2018xmaspreorder" %>
...
<%--    <i class=" am-icon-smile-o"></i>--%>
    ...
    <section>
        <div style="position: relative">
            <img src="https://www.hawooo.com/images/ftp/20181129/flashm.png" style="width: 100%" />
            <div class="timelineup">
                <a onclick="GetCoupon('2018xmas5');">
                    <img src="https://www.hawooo.com/images/ftp/20181129/santa_am.png" alt="Santa" style="top: 47.5%; width: 17%; position: absolute; left: 0%">
                </a>
                <a onclick="GetCoupon('2018xmas6');">
                    <img src="https://www.hawooo.com/images/ftp/20181129/santa_bm.png" alt="Santa" style="top: 42%; width:28%; position: absolute; left: 72%">
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        function SetInfo() {
            ...
            if ('<%= (Master as mobile).LgType %>' === "en") {
                ...
                msg = "已选购 #QTY# 件，原价 RM #PRICE#，折扣价 RM #SPRICE#，注意! 货量有限，记得在12/12 00:00开始抢先结帐";
            }

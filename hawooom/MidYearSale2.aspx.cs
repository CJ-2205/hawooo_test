...
public partial class mobile_static_MidYearSale2 : System.Web.UI.Page
{

    //public void DoRep()
    //{
    //    if (DateTime.Now >= Convert.ToDateTime("2019-06-25 12:00:00"))
    //        Response.Redirect("MidYearSale2.aspx");
    //}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //DoRep();
            DataTable dt = BindData(727);
            var rand = new Random();
            var employees = dt.AsEnumerable().OrderBy(r => rand.Next()).Take(4).CopyToDataTable();

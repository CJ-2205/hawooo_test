...
public partial class _newhotrank : System.Web.UI.Page
{
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        ...
        if (isMobile)
        {
            ...
            Response.Redirect("../mobile/newhotrank1.aspx" + qstr);      //here
        }
    ...
    {
        string _PC01 = "8b8abd7e-36a7-4982-b973-bde8c1e1bd16";          //折扣卷的guid
        ...
        {
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "login", "doLogin('newhotrank1.aspx');", true);

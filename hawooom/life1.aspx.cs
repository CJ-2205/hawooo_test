...
public partial class mobile_life1 : System.Web.UI.Page
{
    ...
    private void bindDT()
    {
        ...
        searchProp.JoinTxts.Add("INNER JOIN (SELECT SPD01 AS SPD01,SPD02 AS SPD02 FROM SPRODUCTSD WHERE SPD01 IN ('540','541','542') ) AS DT ON  WP01=DT.SPD02  ");

...
public partial class user_static_ValentinesDay_2019ValentinesDay : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/2019ValentinesDay.aspx");
...
WHERE TA.RNUM<=3)");
    ...
    private void BindBrand()
    {
        ...
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=199", "bd_04"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=235", "bd_05"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=320", "bd_06"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=345", "bd_07"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=343", "bd_08"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=102", "bd_09"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=295", "bd_10"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=340", "bd_11"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=339", "bd_12"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=151", "bd_13"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=163", "bd_14"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=283", "bd_15"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=310", "bd_16"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=264", "bd_17"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=309", "bd_18"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=362", "bd_19"));
        list.Add(new BrandCs("https://www.hawooo.com/user/brands.aspx?bid=96", "bd_20"));

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="bk_fri_life_sale.aspx.cs" Inherits="mobile_static_bk_fri_life_sale" %>
     ...
     <div class="am-g  main-contain">
        <div class="am-container">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "/ftp/20191127/bnn_04m.png"%>' alt="" style="width: 100%;" />
            </div>
            <section>

...
public partial class user_getcoupon : System.Web.UI.Page
{
    ...
    private void bindProduct()
    {
        ...
        string StrCmd = "SELECT SPD01,SPD02,WP01 ,WP02 ,WP08_1 ,WPA06 , WPA10 FROM SPRODUCTSD  CROSS APPLY (SELECT TOP 8 WP.WP01 AS WP01 ,WP02 ,WP08_1 ,Price AS WPA06 ,OPrice AS WPA10  FROM WP INNER JOIN ProductPriceView ON WP.WP01=PID  WHERE WP.WP01=SPD02 ORDER BY WP27 DESC ) AS DT  WHERE SPD01 IN (@E1,@E2,@E3,@E4,@E5,@E6,@E7,@E8)  ORDER BY SPD02 ASC";
    ...
    protected void lnk_get_coupon_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "login", "doLogin('getcoupon.aspx');", true);
    ...
    //protected void lnk_member_counpon_Click(object sender, EventArgs e)
    //{
    //    if (Session["A01"] != null)
    //    {
    ...
    protected void lnk_get_all_Click1(object sender, ImageClickEventArgs e)
    {
        if (Session["A01"] != null)
        {
            int rval = CouponFacade.GetProductCouponUserGetFac.UserGetAllCoupon(Convert.ToInt32(Session["A01"].ToString()));

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200604mys1.aspx.cs" Inherits="mobile_static_200604mys1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <title>Mid Year Sale</title>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--MB  Contain Max-width:650px(Start) ==========================================--%>
    <div class="am-g main-contain mb-contain" id="top" style="background: #DCDDDD;">
        <div class="am-margin-bottom">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_01m.png" %>' alt="main-banner" />
        </div>
        ...
        <section class="am-margin-bottom" id="s1">
            <div class="am-margin-bottom-sm">
                <a href="200604mys1_hot_deal.aspx" target="_blank">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_03m.png" %>' alt="bn_03m" />
                </a>
            </div>
            <div class="am-padding-top-sm" style="background: #FF004F;">
                ...
                <div class="am-padding-vertical-sm">
                    <a class="am-u-sm-5 am-u-md-4 am-u-sm-centered am-block" href="200604mys1_hot_deal.aspx" target="_blank">
                        <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/20200604/more.png" alt="more" />
                    </a>
                </div>
            </div>
        </section>
        ...
        <section class="am-margin-bottom" id="s2">
            <div class="am-padding-bottom-sm">
                <a href="200604mys1_buy1free1.aspx" target="_blank">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_04m.png" %>' alt="bn_04m" />
                </a>
            </div>
            <div class="am-padding-top-sm" style="background: #067C99;">
                ...
                <div class="am-padding-vertical-sm">
                    <a class="am-u-sm-5 am-u-md-4 am-u-sm-centered am-block" href="200604mys1_buy1free1.aspx" target="_blank">
                        <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/20200604/more.png" alt="more" />
                    </a>
                </div>
            </div>
        ...
        <section class="am-margin-bottom" id="s3">
            <div class="am-margin-bottom-sm">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_05m.png" %>' alt="bn_05m" />
            </div>
            ...
            <div>
                <ul class="am-avg-sm-3">
                    <li onclick="goto('top',800,'swing')">
                        ...
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_00m.png" %>' alt="ss_00m" />

                    </li>
                    <li onclick="goto('s1',800,'swing')">

                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_01m.png" %>' alt="ss_01m" />

                    </li>
                    <li onclick="goto('s2',800,'swing')">

                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_02m.png" %>' alt="ss_02m" />

                    </li>
                    <li onclick="goto('s3',800,'swing')">

                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_03m.png" %>' alt="ss_03m" />

                    </li>
                    <li onclick="goto('s4',800,'swing')">

                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_04m.png" %>' alt="ss_04m" />

                    </li>
                    <li onclick="goto('s5',800,'swing')">

                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_05m.png" %>' alt="ss_05m" />
        ...
        function getMysCoupon(type) {
            ...
            if (u == null) {
                ...
                $(".main-contain").click(function () {
                    location.href = 'login.aspx?rurl=200604mys1.aspx';
                });
            } else {

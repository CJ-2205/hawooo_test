<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18WorldCup2.aspx.cs" Inherits="_18WorldCup2" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <div style="width: 100%; position: relative; width: 900px; z-index: 1; margin: 0 auto">
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180706/pro/edm_01.png" alt="Play&Win 最高得RM55" style="width: 100%" />
        ...
        <div style="width: 100%; position: relative; width: 900px; z-index: 1; margin: 0 auto">
            ...
            <img src="https://www.hawooo.com/images/ftp/20180629/edm_02.png" alt="預告" style="width: 100%; float: left;">
        </div>
            ...
            <div class="am-cf sale2">
                <div style="padding: 0 0px; float: left; width: 100%; z-index: 3;">
                    <ul class="am-avg-sm-4">
                        ...
                        <li id="Brazil" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Brazil')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/002.png" style="width: 100%;" alt="Brazil" />
                        </li>


                        <!--第2排-->
                        <li id="Belgium" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Belgium')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/005.png" style="width: 100%;" alt="Belgium" />
                        </li>


                        <!--第3排-->
                        <li id="Croatia" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Croatia')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/009.png" style="width: 100%;" alt="Croatia" />
                        </li>

                        <li id="France" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('France')">
                        ...
                        <li id="Russia" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Russia')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/015.png" style="width: 100%;" alt="Russia" />
                        </li>

                        <!--第5排-->
                        <li id="England" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('England')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/017.png" style="width: 100%;" alt="England" />
                        </li>


                        <!--第6排-->
                        <li id="Uruguay" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Uruguay')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/021.png" style="width: 100%;" alt="Uruguay" />
                        </li>


                        <!--第7排-->

                        <li id="Sweden" class="am-fl hvr-float before" style="width: 23%;" onclick="SelTeam('Sweden')">
                            <img src="https://www.hawooo.com/images/ftp/20180620/32/026.png" style="width: 100%;" alt="Sweden" />
                        </li>

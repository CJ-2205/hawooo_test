<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="hotProduct.aspx.cs" Inherits="user_hotProduct" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/hotProduct.aspx";
                }
            }
        }
         )
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-show-md-up">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20171012/salesale.png" alt="Hot Sale">
        </div>
    </div>

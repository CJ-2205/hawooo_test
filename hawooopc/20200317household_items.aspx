<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20200317household_items.aspx.cs" Inherits="user_static_20200317household_items" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        $(function () {
            $(".bg1 li").attr("class", "am-fl hvr-float");
        });
    </script>
</asp:Content>

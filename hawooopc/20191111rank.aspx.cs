...
public partial class user_20191111rank : System.Web.UI.Page
{
    private string sdate = "2018-01-01 00:00:00";
    private string edate = "2019-10-01 00:00:00";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "location.href='../mobile/20191111rank.aspx'", true);
                }
            }

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20191111pre_sale.aspx.cs" Inherits="user_static_20191111pre_sale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain">
        <a href="20191111pre_sale.aspx" target="_blank">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191111/bbn_01.png" %>' alt="bbn_03" style="width: 100%;" />
        </a>

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20181111brand.aspx.cs" Inherits="mobile_20181111brand" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;">
        <a href="#">
            <img id="mainImg" src="https://www.hawooo.com/images/ftp/20181101/mbds_01.png" runat="server" style="float: left; display: block; width: 100%;" />
        </a>
    </div>
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eee">
        <h4 class="edm_title" id="t1" runat="server" visible="false">Fashion&Lingeires</h4>
    </div>
    <!--第0塊商品-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        <asp:Repeater ID="rp0" runat="server" OnItemDataBound="rp0_ItemDataBound">
            <ItemTemplate>
                <asp:HiddenField ID="hfBID" runat="server" Value='<%#Eval("BID") %>' />
                <div class="brand-img" style="padding-top:10px;background-color:white">
                    <a href='<%#"https://www.hawooo.com/mobile/brand_1.aspx?bid="+ Eval("BID") %>'>
                        <img src='<%#Eval("IMG") %>' width="100%" />
                    </a>
                    <p><%#Eval("NOTE") %></p>
                </div>
                <div style="padding: 0;">
                  <%--  <div class="am-u-sm-12 am-fr index-more-products-list" style="width:100%;">--%>
                        ...
                        <div data-am-widget="slider" class="am-slider am-slider-b3 " data-am-flexslider="{itemWidth: 135, itemMargin: 10, slideshow: false,move:4,controlNav:false,directionNav:false}" style="height:auto;background-color:white">
                            <ul class="am-slides">
                                <asp:Repeater ID="rp1" runat="server">
                                    <ItemTemplate>
                                  <%--      <li class="am-fl box">--%>
                                          <li style="border: none;width:130px;padding-right:5px" >

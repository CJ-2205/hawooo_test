<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="flashsale.aspx.cs" Inherits="user_static_mycybersale_flashsale" %>
        ...
        <div class="am-container  am-padding-vertical-lg main-contain">
            <section class="shop-block-wrap  am-padding-vertical-lg am-margin-vertical-lg">
                <div class="banner-box am-text-center ">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190927/bn_02.png" %>' alt="Banner" style="width: 100%;" />
                </div>
                <div class="shop-block  am-padding" id="product-make1">

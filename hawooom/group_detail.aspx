<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="group_detail.aspx.cs" Inherits="mobile_group_detail" %>
                        ...
                        <li class="am-fl">
                            ...
                            <a href="product.aspx?id=<%# Eval("WP01").ToString() %>">
                                <div class="index-items-text">
                                    ...
                                    <p><%# WPFactory.DisPriceStr(Eval("WPA06").ToString(),Eval("WPA10").ToString())%></p>

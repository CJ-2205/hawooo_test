...
public partial class user_20181111sales : System.Web.UI.Page
{
    private int did = 1;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "location.href='../mobile/20181111sales.aspx'", true);
                }
            }
            ...
            switch (did)
            {
                case 1:
                    {
                        listId.Add(482);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181101/b1f1_01.png";
                        break;
                    }
                case 2:
                    {
                        ...
                        listId.Add(484);
                        listId.Add(483);
                        mainImg.Src = "https://www.hawooo.com/images/ftp/20181101/up_01.png";
                        Panel1.Visible = true;
                        t1.Visible = true;
                        break;
                    }

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa05.aspx.cs" Inherits="user_qa05" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">如何使用Ha幣和購物金？</h4>
                <div class="qa-main">
                    <h5 class="qa-step">
                        <p class="qa-step-title">下單時請留意以下資訊：<br>
                            「使用Ha幣」 - 點選所要使用的折抵方式（1500點折抵運費 or 全額折抵訂單金額）<br>
                            「使用購物金」 - 輸入所要使用的金額</p>
                    </h5>


                    <p class="qa-step-title" style="font-size: 15px">(備註:使用後，請確認金額是否扣除)</p>

                    <img class="qa-answer-img" src="https://www.hawooo.com/images/ftp/test/qa05p1.png">
                </div>
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">How to use Ha Coin and HaWooo shopping credit?</h4>
                <div class="qa-main">
                    <h5 class="qa-step">‧<p class="qa-step-title-eng">There are Ha Coin and shopping credit column at the checkout page. The total amount will deducted once the Ha Coin or/and shopping credit used.</p>
                    </h5>

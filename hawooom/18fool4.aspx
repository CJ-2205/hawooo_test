<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18fool4.aspx.cs" Inherits="_18fool4" MasterPageFile="~/mobile/mobile.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="sale1" class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        <img alt="保健母嬰" src="https://www.hawooo.com/images/ftp/20180330/sec_4.png" style="float: left; display: block; width: 100%;" />
    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200409hw_staraward.aspx.cs" Inherits="mobile_static_200409hw_staraward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain" id="top">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200410/bn_01m.png" %>' alt="main-banner" />
        </div>

        <%-- <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200409/bn_02m.png" %>' alt="bn_02m" style="width: 100%;" />
        </div>--%>

        <%--===================== Super Items Start =====================--%>
        <section class="block1 am-margin-vertical-lg">
            <div>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200410/bn_02m.png" %>' alt="bn_04" />
            </div>
        </section>
        <%--===================== Super Items End ===================--%>
                                            ...
                                            <div class="product-item" style="text-align: initial">
                                                ...
                                                <div class="product_item_text">
                                                    ...
                                                    <div class="product_item_block am-cf">
                                                        ...
                                                        <span class="product_item_dis"><%# PbClass.GetSave(Eval("WPA10").ToString(),Eval("WPA06").ToString(),Application["mycashrate"].ToString()).Replace("RM","") %></span>
                                                    </div>
                                                    <div class="product_item_block am-cf">
        ...
        <section class="block1 am-margin-vertical-lg">
            <a href="200409super_brands.aspx" target="_blank">
                <div>
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200410/bn_03m.png" %>' alt="bn_03m" />
                </div>

                <%-- <div class="am-u-sm-4 am-u-md-3 am-u-sm-centered am-padding-xs">
        ...
        <section class="block1 am-margin-vertical-lg" style="background-color: #F8D604">
            <a href="200409best_picks.aspx" target="_blank">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200410/bn_04m.png" %>' alt="" />
                <%--<div class="am-u-sm-4 am-u-md-3 am-u-sm-centered am-padding-xs">

...
public partial class user_static_2020CNY3_HW_recommendation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/2020CNY3_HW_recommendation.aspx" + Request.Url.Query);

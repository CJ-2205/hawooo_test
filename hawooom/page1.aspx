<%@ Page Language="C#" AutoEventWireup="true" CodeFile="page1.aspx.cs" MasterPageFile="~/mobile/mobile.master" Inherits="_17_12_17_NewYear_page1" %>
    ...
    <div>
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20180104/168/0104edmm_06.png" alt="禮盒最熱賣"></div>
        </div>


        <!--系統開始帶商品-->
        <!--下方商品-->
        <div class="pageBoxGreen" style="background-color: #1e0576;">

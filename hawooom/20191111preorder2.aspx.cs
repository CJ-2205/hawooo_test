...
public partial class mobile_20191111preorder2 : System.Web.UI.Page
{
    ...
    public void BindProductList(int selectID)
    {
        ...
        {
            rp.DataSource = mdt.Select("SPD08='A'").Take(2).CopyToDataTable();
            rp.DataBind();
            rp1all.DataSource = mdt.Select("SPD08='A'").CopyToDataTable();
            rp1all.DataBind();
        }
        if (mdt.Select("SPD08='B'").Length > 0)
        {
            rp2.DataSource = mdt.Select("SPD08='B'").Take(2).CopyToDataTable();
            rp2.DataBind();
        ...
        {
            rp3.DataSource = mdt.Select("SPD08='C'").Take(2).CopyToDataTable();
            rp3.DataBind();
        ...
        {
            rp4.DataSource = mdt.Select("SPD08='D'").Take(2).CopyToDataTable();
            rp4.DataBind();

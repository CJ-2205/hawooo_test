<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="skincaredpa.aspx.cs" Inherits="mobile_skincaredpa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;" onclick="RedeemCoupon();">
        <a href="#">
            <img alt="midterm sale" src="https://www.hawooo.com/images/ftp/20180717/edmm_01.png" style="float: left; display: block; width: 100%;" /></a>
    ...
    <script>
        function RedeemCoupon() {
            ...
            if (u != null)
                ...
                location.href = 'login.aspx?rurl=skincaredpa.aspx';
            }
        <%--       function GetSpend() {
    ...
    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto; margin-bottom: -1px;">
        ...
        <a href="skincaredpa.aspx?did=1">
            <img src="https://www.hawooo.com/images/ftp/20180717/edmm_02.png" style="width: 33.3%; float: left;"></a>
        <a href="skincaredpa.aspx?did=2">
            <img src="https://www.hawooo.com/images/ftp/20180717/edmm_03.png" style="width: 33.3%; float: left;"></a>
        <a href="skincaredpa.aspx?did=3">
            <img src="https://www.hawooo.com/images/ftp/20180717/edmm_04.png" style="width: 33.3%; float: left;">
        </a>
        ...
        <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
            ...
            <a href="#" runat="server" id="hidpl">
                <img id="hidimg" visible="false" runat="server" src="https://www.hawooo.com/images/ftp/20180717/select.png" alt="第一塊" style="position: absolute; top: 0; margin: auto; width: 50%; left: 0; " />
            </a>

            <a href="#" id="hidimg2" visible="false" runat="server">
                <img src="https://www.hawooo.com/images/ftp/20180717/select2.png" alt="第2塊" style="position: absolute; top: 0; margin: auto; width: 50%; left: 50%;" />
            </a>

            <a href="#" id="hidimg3" visible="false" runat="server">
                <img src="https://www.hawooo.com/images/ftp/20180717/select3.png" alt="第3塊" style="position: absolute; top: 0; margin: auto; width: 50%; left: 101.5%;" />
            </a>
    ...
    <div style="max-width: 650px; background-color: #7ec1ed; margin: 0 auto;">

        <div class="am-cf" style="max-width: 585px; background-color: #7ec1ed; margin: 0 auto;">

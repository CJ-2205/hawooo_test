<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200325beauty_care.aspx.cs" Inherits="user_static_200325beauty_care" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg" id="top">
        <section class="am-container">
            <div class="am-text-center">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200320/bnn_02.png" %>'alt="bnn_02" style="width: 100%;" />
            </div>

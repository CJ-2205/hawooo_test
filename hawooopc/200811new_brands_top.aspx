<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200811new_brands_top.aspx.cs" Inherits="user_static_200811new_brands_top" %>
    ...
    <div class="am-g main-contain" style="background: #FFF3EE">
        ...
        <div class="side-bar">
            <ul>
                ...
                <li>
                    <a href="200811new_brands.aspx?#s5" target="_blank">
        ...
        <div class="am-container am-margin-vertical-lg">
            <div>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200811/bbn_01.png" + "?cacheVersion=" + cacheVersion %>'>
            </div>
            <%--領取折扣券 (Start)====================================================--%>

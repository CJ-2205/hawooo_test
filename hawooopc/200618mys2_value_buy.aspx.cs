...
public partial class user_static_200618mys2_value_buy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200618mys2_value_buy.aspx" + Request.Url.Query);
            }

            // Todo: Change 777 (event id) to real event id.
            //BindProduct(productValueBuy, 777, 0);
            BindProduct(productValueBuy, 1003, 0);
            //BindTop8ClassData();
            BindCoupnCount();
        }
    }

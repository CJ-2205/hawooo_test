<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2017motherday.aspx.cs" Inherits="mobile_2017motherday" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-container am-show-md-up" style="margin-top: 20px; width: 100%; max-width: 1180px">
        ...
        <!--     hello     -->
        <div class="am-u-sm-12 fullBanner" style="width: 100%">

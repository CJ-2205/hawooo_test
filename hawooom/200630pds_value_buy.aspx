<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200630pds_value_buy.aspx.cs" Inherits="mobile_static_200630pds_value_buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #F1E3CE;">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200630/bbn_02m.png" + "?cacheVersion=" + cacheVersion %>' alt="main-banner" />
        </div>
        ...
        <div class="footer-bar">
            <div>
                <ul class="am-avg-sm-3">
                    ...
                    <li>
                        <a href="200630pds_hot_deal.aspx" target="_blank">
                    ...
                    <li>
                        <a href="200630pds.aspx?#s4" target="_blank">
                            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200630/ss_04m.png" + "?cacheVersion=" + cacheVersion %>' alt="ss_04m" /></a>
                    </li>

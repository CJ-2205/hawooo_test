...
public partial class Webform_MailCoupon : System.Web.UI.Page
{
    public string query = "";
    public int t01 = 0;
    ...
    protected void Page_Preload(object sender, EventArgs e)
    {
        ...
        if (isMobile)
        {
            ...
            Response.Redirect("../mobile/mailcoupon.aspx" + qstr);
        }
        else
        {
            ...
            if (query == "85")
            {
                img.ImageUrl = "https://www.hawooo.com/images/ftp/20171113member/clickrm30.gif";
                t01 = 9;
            }
            else
            {
                img.ImageUrl = "https://www.hawooo.com/images/ftp/20171113member/clickrm15.gif";
                t01 = 8;
            }
        }
    }
...
ORDER BY MT02 DESC";
    ...
    protected void GetCoupon_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(UPCoupon, typeof(UpdatePanel), "cartMsg", "doLogin('mailcoupon.aspx');", true);
        }
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="lovemom.aspx.cs" Inherits="user_lovemom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; width: 999px; z-index: 1; margin: 0 auto">
        ...
        <a href="#" onclick="RedeemCoupon();">
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180709/edm_01.png" alt="點我領折扣券" style="width: 100%"></a>
    ...
    <div style="width: 1000px; margin: 0 auto; background-color: #fee4eb;">
        <div class="am-g sale1">
            <div id="div2" style="padding: 0 0px; float: left; width: 100%;">
                <ul class="am-avg-sm-4 " style="padding: 2px">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li class="am-fl hvr-float" style="width: 23%; background-color: #fee4eb; padding: 2px; margin: 1% 1%;">

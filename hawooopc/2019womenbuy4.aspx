<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true"
    CodeFile="2019womenbuy4.aspx.cs" Inherits="user_2019womenbuy4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- 小選單掰掰-->
    <div style="width: 1180px; margin: 0 auto; position: relative; background-color: #FFE7BC">
        <!--限時商品 倒數計時結束-->
        <!--限時商品 帶商品吧-->
        <a href="#" id="coupon1" data-clipboard-text="FOOD10" onclick="Clip('coupon1');">
            <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/fbn_01.png" %>' style="margin: 0 auto; width: 100%" /></a>

        <ul class="am-avg-md-2">
            <li>
                <a id="coupon1" data-clipboard-text="FOOD5" onclick="Clip('coupon1');">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_01.png"%>' alt="coupon1" style="width: 100%;" />
                </a>
            </li>
            <li>
                <a id="coupon2" data-clipboard-text="FOOD10" onclick="Clip('coupon2');">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_02.png"%>' alt="coupon2" style="width: 100%;" />
                </a>
            </li>
            <%--<li>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190711/fcoupon_03.png"%>' alt="coupon3" style="width: 100%;" />
            </li>--%>
        </ul>

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="dpaevent3.aspx.cs" Inherits="mobile_dpaevnet1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        function RedeemCoupon() {
            ...
            if (u != null)
                ...
                location.href='login.aspx?rurl=dpaevent3.aspx';
        }
    ...
    <div class="am-container" style="background-color: #ffffff;">
        <div class="am-g" style="position: relative">
            <img src="../images/ftp/dpa3/edmm_01.png" width="100%" />
                ...
                <li>
                    <a href="dpaevent3.aspx?did=1">
                        <div style="position: relative;">
                            ...
                            <img id="_1" src="../images/ftp/dpa3/dpa01.gif" width="100%" />
                            <div id="d1">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent3.aspx?did=2">
                        <div style="position: relative;">
                            ...
                            <img id="_2" src="../images/ftp/dpa3/dpa02.png" width="100%" />
                            <div id="d2">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent3.aspx?did=3">
                        <div style="position: relative;">
                            ...
                            <img id="_3" src="../images/ftp/dpa3/dpa03.png" width="100%" />
                            <div id="d3">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent3.aspx?did=4">
                        <div style="position: relative;">
                            ...
                            <img id="_4" src="../images/ftp/dpa3/dpa04.png" width="100%" />
                            <div id="d4">
                            </div>
                        </div>
                    </a>
                ...
                <li>
                    <a href="dpaevent3.aspx?did=5">
                        <div style="position: relative;">
                            ...
                            <img id="_5" src="../images/ftp/dpa3/dpa05.png" width="100%" />
                            <div id="d5">
                            </div>
                        </div>
                    </a>

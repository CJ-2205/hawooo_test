<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20200325cosmetic_flash_deals.aspx.cs" Inherits="mobile_static_20200325cosmetic_flash_deals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g  main-contain">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200325/bbn_02m.png" %>' alt="bbn_01m" style="width: 100%;" />
        </div>
        ...
        <div class="am-container">
            <section>
                <div class="mb-shop-block bg2 goods-mb bg1">

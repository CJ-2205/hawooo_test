<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="mom_bady.aspx.cs" Inherits="user_static_mom_bady" %>
    ...
    <div class="am-g main-contain">
        <div class="am-container  am-padding-vertical-lg main-contain">
            <section class="shop-block-wrap  am-padding-vertical-lg am-margin-vertical-lg">
                ...
                <div class="shop-block shop-block3 am-padding" id="product-make1">

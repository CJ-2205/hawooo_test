...
public partial class mobile_static_2020momsday2flash_sale : System.Web.UI.Page
{
    //private int eid = 949;
    ...
    public void BindProductList(int selectID)
    {
        ...
        rp1.DataBind();
        rp1_1.DataSource = mdt;
        rp1_1.DataBind();

        rp2.DataSource = mdt.AsEnumerable().Take(6).CopyToDataTable();
        rp2.DataBind();
        rp2_1.DataSource = mdt;
        rp2_1.DataBind();

        rp3.DataSource = mdt.AsEnumerable().Take(6).CopyToDataTable();
        rp3.DataBind();
        rp3_1.DataSource = mdt;
        rp3_1.DataBind();

        //if (mdt.Select("SPD08='A'").Length > 0)
        //{
        //    rp1.DataSource = mdt.Select("SPD08='A'").Take(6).CopyToDataTable();
        //    rp1.DataBind();
        //    rp1_1.DataSource = mdt.Select("SPD08='A'").CopyToDataTable();
        //    rp1_1.DataBind();
        //}
        ...
        //    rp2.DataBind();
        //    rp2_1.DataSource = mdt.Select("SPD08='B'").CopyToDataTable();
        //    rp2_1.DataBind();
        //}
        ...
        //    rp3.DataBind();
        //    rp3_1.DataSource = mdt.Select("SPD08='C'").CopyToDataTable();
        //    rp3_1.DataBind();
        //}

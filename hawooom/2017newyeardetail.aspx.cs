...
public partial class mobile_2017newyeardetail : System.Web.UI.Page
{
    ...
    private void bindProduct(int eid)
    {
        ...
        //dt = CFacade.UserFac.GetShopList2(0, 0, "WP27 DESC", 0, 100, eid, "", "", "");
    ...
    private void bindDT(string Type)
    {
            ...
            case "A": //2017年度暢銷金榜
                {
                    ...
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageA_banner_m.png' alt='年度暢銷金榜,全部免運'></div>
                    @EVENT 
                    </div>
            ...
            case "C": //90%off
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageC_banner_m.png' alt='Crazy Clearance Sales,Up to 90%OFF,好便宜，不买吗？'></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
            ...
            case "D": //不敗組合經典必BUY
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageD_banner.png' alt=''></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
            ...
            case "E": //BHK's購物好雞會
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageE_banner_m.png' alt=''></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
            ...
            case "F": //桃花美妝
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageF_banner_m.png' alt='桃花美妝特輯,這個新年你最正,全館商品，up to 40%off！'></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
            ...
            case "G":
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageG_banner_m.png' alt='新年穿搭術,30%off，全館時尚類品牌，消費滿RM350，送 FM鞋蜜'></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
            ...
            case "H":
                {
                    ...
                    <div class='am-show-sm'>
                    <div class='fullBanner'><img src='http://edm.hawooo.com/20170112/pageH_banner_m.png' alt='開運美食榜,要得到他的心，先得到他的胃！'></div>
                    @EVENT 
                    </div>
                    <div class='am-container' style='margin-top:20px;margin-bottom:20px;'>
                    <div class='am-u-md-6 am-u-sm-12 mainBanner'>
        ...
        sb.Append("<div class=\"fullBanner\"><img src=\"http://edm.hawooo.com/20170112/newyear-top-m_1.png\" alt=\"新年活動倒數\"></div>");
        sb.Append("<div class=\"fullBanner\"><img src=\"http://edm.hawooo.com/20170112/newyear-top-m_2.png\" alt=\"\"></div>");
        sb.Append("<div class=\"fullBanner\"><a><img src=\"http://edm.hawooo.com/20170112/newyear-top-m_3.png\" alt=\"點我領Rm20\" onclick='GetCoupone(\"2017-01-12 00:00\", \"2017-02-01 00:00\", \"e401b092-c052-4406-a7d7-c3f522fa57df\");'></a></div>");
        sb.Append("<div class=\"fullBanner\"><a><img src=\"http://edm.hawooo.com/20170112/newyear-top-m_4.png\" alt=\"點我領Rm30\" onclick='GetCoupone(\"2017-01-18 00:00\", \"2017-02-01 00:00\", \"28e575b3-042a-4b9e-8c1d-348b51fe5b6d\");'></a></div>");
        sb.Append("<div class=\"fullBanner\"><a><img src=\"http://edm.hawooo.com/20170112/newyear-top-m_5.png\" alt=\"點我領Rm50\" onclick='GetCoupone(\"2017-01-25 00:00\", \"2017-02-01 00:00\", \"0f15ce48-3a9a-4fb1-b934-818a40b8d027\");'></a></div>");
        ...
        p_header.Controls.Add(_header);
        p_footer.Controls.Add(_footer);
    }
    private void stxt()
    {

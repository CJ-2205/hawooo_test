<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="getcoupon1.aspx.cs" Inherits="mobile_getcoupon1" %>
    ...
    <div>
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <div class="fullBanner">
                    <img src="https://www.hawooo.com/images/ftp/20171116/iedmm_01.png" alt="排行"></div>
            </div>
        </div>
        ...
        <footer class="fullBanner am-show-sm">
            <a href="getcoupon.aspx">
                <img src="https://www.hawooo.com/images/ftp/20171116/goback.png" alt="HaWooo.com"></a>
        </footer>

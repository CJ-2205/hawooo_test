<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200630pds_value_buy.aspx.cs" Inherits="user_static_200630pds_value_buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="am-g main-contain" style="background: #F1E3CE;">
    ...
    <div class="am-container am-margin-vertical-lg">
      <div>
        <img class="am-margin-bottom-xl" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200630/bbn_02.png" + "?cacheVersion=" + cacheVersion %>'
          alt="bbn_02" />
      </div>

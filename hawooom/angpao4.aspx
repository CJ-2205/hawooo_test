<%@ Page Language="C#" AutoEventWireup="true" CodeFile="angpao4.aspx.cs" Inherits="angpao4" MasterPageFile="~/mobile/mobile.master" %>
  ...
  <link rel="stylesheet" href="assets/css/newyearmom.css">--%>
    <div>
        ...
        <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eb3a27">
            <a href="angpao4.aspx" target="_blank">
                <img alt="除舊佈新" src="https://www.hawooo.com/images/ftp/20180116/edmm_18.gif" style="float: left; display: block; width: 100%;" />

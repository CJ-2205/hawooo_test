<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200604mys1.aspx.cs" Inherits="user_static_200604mys1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain" style="background: #DCDDDD;">
        <%--側邊選單 (Start) ======================================================--%>
        <div class="side-bar">
            <ul>
                <li onclick="goto('top')">
        ...
        <div class="am-margin-bottom-xl" id="top">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_01.png" %>' alt="主banner" />
        </div>
        ...
        <div class="am-container">
            ...
            <section class="am-margin-bottom-xl" id="s1">
                <div>
                    <a href="200604mys1_hot_deal.aspx" target="_blank">
                        <img class="am-margin-bottom-sm"
                            src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_03.png" %>' alt="bn_03" />
                    </a>
                </div>
                <div style="background: #FF004F;">
                    ...
                    <div class="am-padding-vertical-lg am-u-sm-3 am-u-sm-centered">
                        <a href="200604mys1_hot_deal.aspx" target="_blank">
                            <img class="" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/more.png" %>' alt="more" />
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section class="am-margin-bottom-xl" id="s2">
                <div>
                    <a href="200604mys1_buy1free1.aspx" target="_blank">
                        <img class="am-margin-bottom-sm"
                            src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_04.png" %>' alt="bn_04.png" />
                    </a>
                </div>
                <div style="background: #067C99;">
                    <div class="am-padding pc-slider">
                        <div class="swiper-container swiper-container7" id="block1">
                            <ul class="swiper-wrapper">
                                <uc1:products runat="server" id="productBuy1free1" />
                                <li class="am-fl swiper-slide am-text-center goods-more">
                                    <a href="200604mys1_buy1free1.aspx" target="_blank">
                                        <div class="am-panel am-panel-default pitem" style="padding: 0; border: 0; margin-bottom: 0">
                                            <div class="imgContain" style="padding: 10px; width: 91%; margin: auto">
                                                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/hw_event/more.png" %>'
                                                    alt="more" />
                                            </div>
                                        </div>
                                        <div class="goods-bottom">
                    ...
                    <div class="am-padding-vertical-lg am-u-sm-3 am-u-sm-centered">
                        <a href="200604mys1_buy1free1.aspx" target="_blank">
                            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/more.png" %>' alt="more" />
                        </a>
                    </div>
                </div>
            </section>
            ...
            <div style="position: relative;" id="s3">
                <div>
                    <img class="am-margin-bottom-sm" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bn_05.png" %>'
                        alt="bn_05" />
                </div>
                <section class="am-margin-bottom-xl" style="background: #362E2B">
                    <div class="am-padding-sm shop-block highlighted-brands" id="logo" style="background: #362E2B">
                        <ul class="am-avg-sm-4">

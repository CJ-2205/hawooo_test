<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa32.aspx.cs" Inherits="user_qa32" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="am-container qa-wrapper">
                    ...
                    <div id="qa-tab-3" class="am-panel-collapse am-collapse am-in">
                        <div class="am-panel-bd qa-list">
                            <ul>
                                ...
                                <li class="active"><a href="qa32.aspx">貨運條款</a></li>
        ...
        <div class="qa-content">
            <h4 class="qa-height qa-maintitle">貨運條款</h4>
            <div class="qa-main">
                <p class="qa-text">

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200401stayhome_supplement.aspx.cs" Inherits="user_static_200401stayhome_supplement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain">
        <section class="am-container am-padding-vertical-lg bg1">
            <div>
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200401/bnn_03.png" %>' alt="bnn_03" style="width: 100%;" />
            </div>
            <div>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200618mys2_value_buy.aspx.cs" Inherits="user_static_200618mys2_value_buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="am-g main-contain"style="background:#A63B24">
    ...
    <div class="am-container am-margin-vertical-lg">
      <div>
        <img class="am-margin-bottom-xl" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/bbn_07.png" %>'
          alt="bbn_02" />
      </div>

...
public partial class _180222 : System.Web.UI.Page
{
    ...
    private void bindProduct1(int eid)
    {
        ...
        cmd.CommandText = CFacade.GetFac.GetWPFac.GetProductListSql2(null, qList, 8, "ORDER BY WP18 DESC ", null, true);
    ...
    protected void lnk_get_all_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(up_header, typeof(UpdatePanel), "msg", "confirm2url('請先登入會員','login.aspx?rurl=180222.aspx');", true);
        }
    }
    ...
    public void getCoupon(string _PC01)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(up_product_coupon, typeof(UpdatePanel), "msg", "confirm2url('請先登入會員','login.aspx?rurl=180222.aspx');", true);

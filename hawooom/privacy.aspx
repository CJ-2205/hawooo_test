<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="privacy.aspx.cs" Inherits="mobile_privacy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 100%; margin: 10px ; float: center; display: block; max-width: 650px;">
        <div class="am-tabs" data-am-tabs="">
            <ul class="am-tabs-nav am-nav am-nav-tabs">
                <li class="am-active"><a href="#tab1">英文版</a></li>
                <li class=""><a href="#tab2">馬來西亞版</a></li>
            </ul>

            <div class="am-tabs-bd" style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                <div class="am-tab-panel am-fade am-active am-in" id="tab1" style="background-color: white;">
                    <span style="font-size: 20px">NOTICE UNDER THE PERSONAL DATA PROTECTION ACT 2010 </span>
                    <br>
                    <br>
                ...
                <div class="am-tab-panel am-fade" id="tab2" style="background-color: white;">
                    <span style="font-size: 20px">NOTIS DI BAWAH AKTA PERLINDUNGAN DATA PERIBADI 2010</span><br>
                    <br>
                    ...
                    <br>
                    12.	Sekiranya terdapat apa-apa ketidak-konsistenan antara versi Bahasa Inggeris dan versi Bahasa Malaysia Notis ini, versi Bahasa Inggeris akan mengatasi versi Bahasa Malaysia.<br>
                    <br>
                </div>

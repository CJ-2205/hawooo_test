<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2019womenbuy5.aspx.cs" Inherits="mobile_2019womenbuy5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black; position: relative">
            <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/lbn_01m.png" %>' style="float: left; display: block; width: 100%;" />
    ...
    <!--第0塊商品-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #e5e5e5" id="bc">

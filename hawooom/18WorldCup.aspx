<%@ Page Language="C#" AutoEventWireup="true" CodeFile="18WorldCup.aspx.cs" Inherits="_18WorldCup" MasterPageFile="~/mobile/mobile.master" %>
    ...
    <div style="max-width: 650px; background-color: #000b04; margin: 0 auto;">
        <div class="am-cf" style="max-width: 585px; background-color: #042107; margin: 0 auto;">
            <ul style="height: 50%; list-style-type: none; margin: 2% 4%; padding: 0;">
                ...
                <li id="France" class="am-fl box before" style="width: 48%" >
                ...
                <!----出局組-->
                <li id="Belgium" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                ...
                <li id="Croatia" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>
                ...
                <li id="England" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>
                ...
                <li id="Uruguay" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>
                ...
                <li id="Sweden" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>
                ...
                <li id="Russia" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>
                ...
                <li id="Brazil" class="am-fl box before" style="width: 48%; position: relative;">
                    <div class="goodbye">
                        <img src="https://www.hawooo.com/images/ftp/test/byebye.png" alt="慢走不送" style="width: 100%;" />
                    </div>

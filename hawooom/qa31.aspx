<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="qa31.aspx.cs" Inherits="mobile_qa31" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 20px" id="zhPanel" runat="server">
      ...
      <div class="qa-wrapper">
        <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a> 服務條款</h4>
		<hr style="margin:0">  
		  
        <div class="qa-content" style="margin-right: 20px;">
          
           <p class="qa-text-eng" style="margin: .8em 0 0 0">
          ...
          <h4 class="qa-title-eng">Use Of The Site</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">User Submissions</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Order Acceptance And Pricing</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Trademarks And Copyrights</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Applicable Law And Jurisdiction</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Arbitration</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Termination</h4>
          <p class="qa-text-eng">
          ...
          <h4 class="qa-title-eng">Terms of Use</h4>
          <h5 class="qa-step">1. Interpretation</h5>
            <table class="qa-term">
              <tr>
                <td>1.1</td>
              ...
              <tr>
                <td>1.3</td>
                <td>The headings in these Conditions are for convenience only and shall not affect the interpretation of any parties.</td>
              </tr>
            </table>
          <br>
          <h5 class="qa-step">2. Basis of the Contract</h5>
            <table class="qa-term">
              <tr>
                <td>2.1</td>
          ...
          <br>
          <h5 class="qa-step">3. Orders and Specifications</h5>
            <table class="qa-term">
              <tr>
                <td>3.1</td>
          ...
          <br>
          <h5 class="qa-step">5. Terms of Payment</h5>
            <table class="qa-term">
              <tr>
                <td></td>
          ...
          <br>
          <h5 class="qa-step">6. Delivery/Performance</h5>
            <table class="qa-term">
              <tr>
                <td>6.1</td>
          ...
          <br>
          <h5 class="qa-step">7. Risk and property of the Goods</h5>
            <table class="qa-term">
              <tr>
                <td>7.1</td>
          ...
          <br>
          <h5 class="qa-step">8. Warranties and Remedies</h5>
            <table class="qa-term">
              <tr>
                <td>8.1</td>
              ...
              <tr>
                ...
                (a) No condition is made or to be implied nor is any warranty given or to be implied as to the life or wear of the Goods supplied or that they will be suitable for any particular purpose or use under any specific conditions, notwithstanding that such purpose or conditions may be known or made known to HaWooo.<br>
                (b) Any description given of the Goods is given by way of identification only and the use of such description shall not constitute a sale by description.<br>
                (c) HaWooo binds itself only to deliver Goods in accordance with the general description under which they were sold, whether or not any special or particular description shall have been given or shall be implied by law. Any such special or particular description shall be taken only as the expression of HaWooo's opinion in that behalf. HaWooo does not give any warranty as to the quality state condition or fitness of the Goods.<br>
                (d) HaWooo shall be under no liability for the following measures and actions taken by the Buyer or third parties and the consequences thereof: improper remedy of defects, alteration of the Goods without the prior agreement of HaWooo, addition and insertion of parts, in particular of spare parts which do not come from HaWooo.<br>
                (e) HaWooo shall be under no liability in respect of any defect arising from unsuitable or improper use, defective installation or commissioning by the Buyer or third parties, fair wear and tear, willful damage, negligence, abnormal working conditions, defective or negligent handling, improper maintenance, excessive load, unsuitable operating materials and replacement materials, poor work, unsuitable foundation, chemical, electro-technical/electronic or electric influences, failure to follow HaWooo's instructions (whether oral or in writing) misuse or alteration or repair of the Goods without HaWooo's approval.<br>
                (f) HaWooo is not liable for any loss damage or liability of any kind suffered by any third party directly or indirectly caused by repairs or remedial work carried out without HaWooo’s prior written approval and the Buyer shall indemnify HaWooo against each loss liability and cost arising out of such claims.<br>
                (g) HaWooo shall be under no liability under the above warranty (or any other warranty condition or guarantee) if the total price for the Goods has not been paid in cleared funds by the due date for payment.<br>
          ...
          <br>
          <h5 class="qa-step">9. Force Majeure</h5>
            <table class="qa-term">
              <tr>
                <td>9.1</td>
                <td>
          ...
          <br>
          <h5 class="qa-step">10. Insolvency of Buyer</h5>
            <table class="qa-term">
              <tr>
                <td>10.1</td>
                <td>
                This condition applies if:<br />
                10.1.1 the Buyer makes any voluntary arrangement with its creditors or becomes subject to an administration order or (being an individual or firm) becomes bankrupt or (being a company) goes into liquidation (otherwise than for the purposes of amalgamation or reconstruction); or<br>
                10.1.2 an encumbrancer takes possession or a receiver is appointed of any of the property or assets of the Buyer; or<br>
                10.1.3 the Buyer ceases - or threatens to cease - to carry on business; or<br>
          ...
          <br>
          <h5 class="qa-step">11.  Notices</h5>
            <table class="qa-term">
              <tr>
                <td></td>
                <td>
                Any notice required or permitted to be given by either party to the other under these Conditions shall be in writing addressed, if to HaWooo, to its registered office or principal place of business and if to the Buyer, to the address stipulated in the relevant offer to purchase.</td>
              </tr>
            </table>
          <br>
          <h5 class="qa-step">12.  Liability</h5>
            <table class="qa-term">
              <tr>
                <td>12.1</td>
                <td>
                HaWooo shall accept liability to the Buyer for death or injury resulting from its own or that of its employees' negligence. Save as aforesaid, HaWooo’s liability under or in connection with the Contract shall be subject to the limitations set out in this Condition
                </td>
              </tr>
              <tr>
                <td>12.2</td>
                <td>
                HaWooo shall be under no liability whatsoever where this arises from a reason beyond its reasonable control as provided in Condition 9 or from an act or default of the Buyer.
                </td>
              </tr>
              <tr>
                <td>12.3</td>
                <td>
                In no event shall HaWooo be liable for loss of profit or goodwill, loss of production or revenue or any type of special indirect or consequential loss whatsoever (including loss or damage suffered by the Buyer as a result of an action brought by a third party) even if such loss were reasonably foreseeable or HaWooo had been advised of the possibility of the Buyer incurring the same.
                </td>
              </tr>
              <tr>
                <td>12.4</td>
                <td>
                Where time of performance has been agreed by HaWooo becomes the essence of the Contract by means of notice by the Buyer to HaWooo, as provided for in Clause 6.4, and HaWooo fails to comply with its obligations in due time, so that the Buyer becomes entitled to compensation in accordance with Condition 6.4, HaWooo’s liability shall be limited to an amount of ½% for each full week of delay, in total to a maximum cumulative amount of 5%, of the value of the delayed Goods.
                </td>
              </tr>
              <tr>
                <td>12.5</td>
                <td>
                The remedies set out in Condition 8 are the Buyer’s sole and exclusive remedies for non-conformity of or defects in the Goods or Services and HaWooo’s liability for the same shall be limited in the manner specified in Condition
                </td>
              </tr>
              <tr>
                <td>12.6</td>
                <td>
                Without prejudice to the sub-limits of liability applicable under this Condition 12 or elsewhere in these Conditions, HaWooo’s maximum and cumulative total liability (including any liability for acts and omissions of its employees agents and sub-contractors) in respect of any and all claims for defective performance, breach of contract, compensation, indemnity, tort, misrepresentation, negligence at law or equity and any other damages or losses which may arise in connection with its performance or non-performance under the Contract, shall not exceed the total Contract price.
                </td>
              </tr>
              <tr>
                <td>12.7</td>
              ...
              <tr>
                <td>12.8</td>
                <td>
                No action shall be brought by HaWooo later than 12 months after the date it became aware of the circumstances giving rise to a claim or the date when it ought reasonably to have become aware, and in any event, no later than 12 months after the end of the Warranty Period.
                </td>
              </tr>
            </table>
          <br>
          <h5 class="qa-step">13.  Termination</h5>
            <table class="qa-term">
              <tr>
                <td>13.1</td>
          ...
          <br>
          <h5 class="qa-step">14.  General</h5>
            <table class="qa-term">
              <tr>
                <td>14.1</td>
   ...
   <section class="am-container member-margin">
      <div class="qa-wrapper">
        <h4 class="qa-title"><a href="qa.aspx"><i class="am-icon-angle-left qa-angle-back"></i></a> Terms of Service</h4>
		<hr style="margin:0">  

...
public partial class user_static_200604mys1_hot_deal : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200604mys1_hot_deal.aspx" + Request.Url.Query);
            }

            // Todo: Change 777 (event id) to real event id.
            BindProduct(productHotDeal, 984, 0);
            BindTop8ClassData();
            BindCouponCount();
        }
    }

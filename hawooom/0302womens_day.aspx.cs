...
public partial class mobile_static_0302womens_day : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                img1.Src = ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200302/bn_03m.png";
                clock1.Style.Add("Top", "60%");
                dt = BindData(790);
            }

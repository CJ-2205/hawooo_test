<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2020CNYtasty_food.aspx.cs" Inherits="user_static_2020CNYtasty_food" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg">
        <section class="am-container ">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191231/bbn_04.png" %>' alt="bbn_04" style="width: 100%;" />
            </div>
            <div class="banner-box am-padding-vertical">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191231/free_02.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>

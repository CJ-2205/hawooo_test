<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200709beauty_sale_hotdeal.aspx.cs" Inherits="mobile_static_200709beauty_sale_hotdeal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" style="background: #F3D0E1;">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200709/bbn_03m.png" + "?cacheVersion=" + cacheVersion %>' alt="main-banner" />
        </div>
    ...
    <script type="text/javascript">
        ...
        function changeLink() {
            ...
            if (dateNow > date1) {
                $('#flashsale-cta').attr("href", "200709beauty_sale_flashsale.aspx");
            }
        };
    </script>
</asp:Content>

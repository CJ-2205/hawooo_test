<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qat02.aspx.cs" Inherits="user_qat02" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">Orders</h4>
                <div class="qa-index">
                    <ul>
                        <li class="qa-text-index-title"><a href="qa12.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            How to place an order?</a></li>
                    </ul>
                </div>
            </div>
            <!-- 右方內容 qa-content end -->

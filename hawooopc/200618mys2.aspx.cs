...
public partial class user_static_200618mys2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200618mys2.aspx" + Request.Url.Query);
            }

            // Todo: Change 777 (event id) to real event id.
            //BindProduct(productHotDeal, 777, 8);
            //BindProduct(productValueBuy, 777, 8);
            //BindProduct(productHighlightedBrands, 777, 12);

            BindProduct(productHotDeal, 1002, 8);
            BindProduct(productValueBuy, 1003, 8);
            BindProduct(productHighlightedBrands, 1004, 12);

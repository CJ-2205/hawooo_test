...
$(function () {
    ...
    $("a[href=#gift1]").click(function () {
        $("html,body").animate({ scrollTop: $("#gift1").offset().top - (120) }, 500);
        return false;
    });


    $("a[href=#gift2]").click(function () {
        $("html,body").animate({ scrollTop: $("#gift2").offset().top - (120) }, 500);
        return false;
    });


    $("a[href=#gift3]").click(function () {
        $("html,body").animate({ scrollTop: $("#gift3").offset().top - (120) }, 500);
        return false;
    });


    $("a[href=#gift4]").click(function () {
        $("html,body").animate({ scrollTop: $("#gift4").offset().top - (120) }, 500);
        return false;
    });


    $("a[href=#gift5]").click(function () {
        $("html,body").animate({ scrollTop: $("#gift5").offset().top - (120) }, 500);
        return false;
    });

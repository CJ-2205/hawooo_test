<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2020CNY3_HW_recommendation.aspx.cs" Inherits="user_static_2020CNY3_HW_recommendation" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg" id="top">
        <section class="am-container shop-block-bg">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200121/bbn_04.png" %>' alt="bbn_04" style="width: 100%;" />
            </div>

            <div class="am-padding-sm shop-block slider-block2">

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200604mys1_hot_deal.aspx.cs" Inherits="mobile_static_200604mys1_hot_deal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-margin-bottom am-g main-contain mb-contain" id="top" style="background: #DCDDDD;">
        <div class="am-margin-bottom">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bbn_01m.png" %>' alt="main-banner" />
        </div>
            ...
            <div>
                <ul class="am-avg-sm-3">
                    ...
                    <li onclick="goto('s5',800,'swing')">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_05m.png" %>' alt="ss_04m" />
                    </li>
                </ul>
            </div>
        </div>

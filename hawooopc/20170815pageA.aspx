<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20170815pageA.aspx.cs" Inherits="user_20170815pageA" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20170815pageA.aspx";
                }
            }
        }
         )
    ...
    <div class="am-show-md-up">
        <div class="fullBanner">
            <a href="" target="_blank">
                <img src="https://www.hawooo.com/images/ftp/20170815/0815A_01.png" alt="A Buy1free1"></a>
        </div>
    </div>
    <div class="am-show-sm">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20170815/am_01.png" alt="A Buy1free1">
        </div>
    </div>
    ...
    <div class="am-show-md-up" style="width: 100%; margin-bottom: -2px; float: left; display: block; max-width: 1920px;">
        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=9146" target="_blank">
                <img alt="【買一送一】INNER SKIN 毛孔緊緻調理精華 50ml" src="https://www.hawooo.com/images/ftp/20170815/0815A_03.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=9165" target="_blank">
                <img alt="【買洗髮精送保護液】NEWART茶樹舒敏止癢洗髮精285ml★送新技活氧茶樹頭皮保護液120ml" src="https://www.hawooo.com/images/ftp/20170815/0815A_04.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=9156" target="_blank">
                <img alt="【買麵送醬】老媽拌麵口味任選3袋組★送「40ml手工麻辣醬」" src="https://www.hawooo.com/images/ftp/20170815/0815A_05.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=9158" target="_blank">
                <img alt="【買三送一】Fa Laiy法婡雅-巴黎多重唇頰彩3件組   送會說話的唇露" src="https://www.hawooo.com/images/ftp/20170815/0815A_06.png" style="float: left; display: block; width: 50%;" /></a></li>

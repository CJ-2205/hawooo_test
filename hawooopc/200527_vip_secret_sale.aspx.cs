...
public partial class user_static_200527_vip_secret_sale : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //if (ismobile)
            //    Response.Redirect("../mobile/200421vip_secret_sale.aspx" + Request.Url.Query);


            DataTable dt = BindData(777);
    ...
    private static string GetCouponCode(CouponReq cr)
    {
        ...
        couponData.ETime = "2020-05-30 23:59:59";
    ...
    //    searchProp.LgType = (this.Master as user).LgType;
    //    searchProp.page = 1;
    ...
    //{
    //    DataTable dt = GetGoods((this.Master as user).LgType, "top15");
    ...
    public DataTable GetGoods(LangType lg, string et = "")
    {
        ...
        sb.Append("(SELECT SPD02 FROM SPRODUCTSD WHERE SPD01 IN (973,974) AND WP01=SPD02) "); // 931, 932 是本次活動商品 ID，目的是用來排除已經出現過的商品。
        if (et == "top4")
        {

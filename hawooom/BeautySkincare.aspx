<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="BeautySkincare.aspx.cs" Inherits="mobile_static_BeautySkincare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g">
        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190618/e_01m.png" %>' style="width: 100%" />
        <!--<img src="https://www.hawooo.com/images/ftp/20190618/e_01m.png" alt="首頁banner" style="width: 100%;" />-->
    </div>

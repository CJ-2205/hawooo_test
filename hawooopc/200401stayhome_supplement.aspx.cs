...
public partial class user_static_200401stayhome_supplement : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/200401stayhome_supplement.aspx" + Request.Url.Query);

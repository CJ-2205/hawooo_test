<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="lovemom2.aspx.cs" Inherits="mobile_lovemom2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black;" onclick="RedeemCoupon();">
        <a href="#">
            <img alt="midterm sale" src="https://www.hawooo.com/images/ftp/20180731/edmm_01.png" style="float: left; display: block; width: 100%;" /></a>
        ...
        function RedeemCoupon() {
            ...
            if (u != null)
                $("#<%= button1.ClientID %>").click();
                    ...
                    location.href = 'login.aspx?rurl=lovemom2.aspx';
            }
        <%--       function GetSpend() {
...
<%--    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto; margin-bottom: -1px;">
                 ...
                 <img src="https://www.hawooo.com/images/ftp/20180731/edmm_01.png" style="width:100%; float: left;">--%>
   ...
   <%--     <a href="lovemom.aspx?did=1">
    ...
    <%--    <div style="display: inline; position: absolute; z-index: 2; width: 66%; top: 0; bottom: 0; left: 0; right: 0;">
            ...
            <a href="#" runat="server" id="hidpl">
                <img id="hidimg" visible="false" runat="server" src="https://www.hawooo.com/images/ftp/180731/select.png" alt="第一塊" style="position: absolute; top: 0; margin: auto; width: 50%; left: 0;" />
            </a>--%>
  ...
  <%--  </div>--%>
    ...
    <div style="max-width: 650px; background-color: #3b3b3b; margin: 0 auto;">

        <div class="am-cf" style="max-width: 585px; background-color: #3b3b3b; margin: 0 auto;">

<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="hawooo2yearsPageD.aspx.cs" Inherits="mobile_hawooo2yearsPageD" %>
    ...
    <div>
        ...
        <div class="am-u-sm-centered" style="position: fixed; bottom: 0; left: 50%; max-width: 650px; text-align: center; transform: translate(-50%); z-index: 999;">
            <ul class="am-avg-sm-4 am-cf" style="list-style-type: none; padding: 0; margin: 0;">
                <li class="am-fl">
                    <a href="hawooo2yearsPageA.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171012/b1.png" style="width: 100%;" alt="美妝"></a></li>


                <li class="am-fl">
                    <a href="hawooo2yearsPageB.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171012/s1.png" style="width: 100%;" alt="保健"></a></li>

                <li class="am-fl">
                    <a href="hawooo2yearsPageC.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171012/l1.png" style="width: 100%;" alt="生活"></a></li>

               <%-- <li class="am-fl">
                    <a href="hawooo2yearsPageD.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171012/f1.png" style="width: 100%;" alt="時尚"></a></li>--%>

                <li class="am-fl">
                    <a href="hawooo2yearsPageE.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171012/m1.png" style="width: 100%;" alt="媽咪寶貝"></a></li>
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20171012/fashion.png" alt="fashion">
            </div>
        </div>
                ...
                <td>
                    <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
                        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
                            ...
                            <li style="margin: 0;">
                                <img alt="熱銷商品" src="https://www.hawooo.com/images/ftp/20171012/001.png" style="float: left; display: block; width: 35%;" /></li>

                            <li style="margin: 0;">
                                <img alt="消費就送每日限量禮" src="https://www.hawooo.com/images/ftp/20171012/002.png" style="float: left; display: block; width: 65%;" /></li>

                            <li style="margin: 0;">
                                <img alt="最高現折Rm100" src="https://www.hawooo.com/images/ftp/20171012/003.png" style="float: left; display: block; width: 60%;" /></li>

                            <li style="margin: 0;">
                                <img alt="消費滿300送面膜抽機票" src="https://www.hawooo.com/images/ftp/20171012/004.png" style="float: left; display: block; width: 40%;" /></li>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="skincaredpa.aspx.cs" Inherits="user_skincaredpa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; width: 999px; z-index: 1; margin: 0 auto">
        ...
        <a href="#" onclick="RedeemCoupon();">
            <img id="gotop" src="https://www.hawooo.com/images/ftp/20180717/edm_01.png" alt="點我領折扣券" style="width: 100%"></a>
        <a href="skincaredpa.aspx?did=1">
            <img src="https://www.hawooo.com/images/ftp/20180717/edm_02.png" alt="寵愛媽咪" style="width: 333px; float: left;">
        </a>
        <a href="skincaredpa.aspx?did=2">
            <img src="https://www.hawooo.com/images/ftp/20180717/edm_03.png" alt="寵愛媽咪" style="width: 333px; float: left;">
        </a>
        <a href="skincaredpa.aspx?did=3">
            <img src="https://www.hawooo.com/images/ftp/20180717/edm_04.png" alt="寵愛媽咪" style="width: 333px; float: left;">
        </a>
    ...
    <div style="width: 1000px; margin: 0 auto; background-color: #7ec1ed;">
        <div class="am-g sale1">
            <div id="div2" style="padding: 0 0px; float: left; width: 100%;">
                <ul class="am-avg-sm-4 " style="padding: 2px">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li class="am-fl hvr-float" style="width: 23%; background-color: #7ec1ed; padding: 2px; margin: 1% 1%;">

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20170921pageB.aspx.cs" Inherits="user_20170921pageB" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20170921pageB.aspx";
                }
            }
        }
         )
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-show-md-up">
        <div class="fullBanner"><a href="" target="_blank">
            <img src="https://www.hawooo.com/images/ftp/20170925/Ha3.png" alt="A Buy1free1"></a></div>
    </div>
    <div class="am-show-sm">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20170925/Ha3_mb.png" alt="A Buy1free1"></div>
    </div>
    ...
    <div class="am-show-md-up" style="width: 100%; margin-bottom: -2px; float: left; display: block; max-width: 1920px;">
        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
            ...
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/brands.aspx?bid=94" target="_blank">
                <img alt="阿嬤的配方" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logo_01.png" style="float: left; display: block; width: 40%;" /></a></li>

            <li style="margin: 0;"><a href="https://www.hawooo.com/user/brands.aspx?bid=35" target="_blank">
                <img alt="i-kirei" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logo_02.png" style="float: left; display: block; width: 20%;" /></a></li>

            <li style="margin: 0;"><a href="https://www.hawooo.com/user/brands.aspx?bid=72" target="_blank">
                <img alt="天堂花園" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logo_03.png" style="float: left; display: block; width: 40%;" /></a></li>
        </ul>
    </div>
            ...
            <td>
                <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
                    <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
                        ...
                        <li style="margin: 0;"><a href="http://www.hawooo.com/mobile/brand_1.aspx?bid=94" target="_blank">
                            <img alt="阿嬤的配方" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logom_01.png" style="float: left; display: block; width: 100%;" /></a></li>

                        <li style="margin: 0;"><a href="http://www.hawooo.com/mobile/brand_1.aspx?bid=35" target="_blank">
                            <img alt="i-kirei" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logom_02.png" style="float: left; display: block; width: 100%;" /></a></li>

                        <li style="margin: 0;"><a href="http://www.hawooo.com/mobile/brand_1.aspx?bid=72" target="_blank">
                            <img alt="天堂花園" src="https://www.hawooo.com/images/ftp/20170925/Ha3_logom_03.png" style="float: left; display: block; width: 100%;" /></a></li>
                    </ul>
                </div>
            </td>
        </tr>

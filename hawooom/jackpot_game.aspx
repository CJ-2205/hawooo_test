<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="jackpot_game.aspx.cs" Inherits="mobile_static_jackpot_game" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--  <link href="../assets/css/jquery.slotmachine.min.css" rel="stylesheet" />--%>
    <link href="assets/css/jackpot_game_m.min.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="jackpot-game">
        ...
        <div class="slot-bg">
            <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/bg.png" alt="bg_img" style="position: relative;" />

            <section class="jackpot-block-top">
                <div class="am-g" style="position: relative;">
                    <div class="am-u-sm-3">
                        <div class="am-fr balloon balloon-left">
                            <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/balloon_left.png" alt="左氣球" />
                        </div>
                    </div>

                    <div class="am-u-sm-6">
                        <div class="bigwin">
                            <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/big_win.svg" alt="bg_img" />
                        </div>
                    </div>
                    <div class="am-u-sm-3">
                        <div class="am-fl balloon balloon-right">
                            <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/balloon_right.png" alt="右氣球" />
                        </div>
                    </div>
            ...
            <section class="slot-machine-contain">
                <div class="slot-machine" style="background: url('https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/slot_machine_mb.png' ) no-repeat  center center;">
                    ...
                    <div class="redeem-ticket">
                        <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/ticket.png" alt="redeem-ticket" />
                    </div>
                    ...
                    <div id="randomizeButton">
                        <a href="#!">
                            <div id="lever-ball">
                                <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/lever_ball.png" alt="pull_up" />
                            </div>
                            <div id="lever-stick">
                                <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/jackpot_game/lever_stick.png" alt="pull_up" />
                            </div>
                        </a>
                    </div>
                    <!--拉桿End-->
        ...
        <section class="am-u-sm-12 am-u-sm-centered award-block">
            ...
            <div class="swiper-container award-slider-contain" id="award">
                <ul class="swiper-wrapper">
                    <asp:Repeater ID="rpGoodBox" runat="server">
                        <ItemTemplate>
                            <li class="am-fl swiper-slide award-box">
                                <a href="#!">
                                    <div class="am-u-sm-6 award-goods">
                                        <img src='<%# "https://p8r7m4d5.stackpathcdn.com/images//webimgs/" + Eval("img") %>' />
                                    </div>
                                    <div class="am-u-sm-6 award-info-box">
                    ...
                    <%--<li class="am-fl swiper-slide award-box">
                        <a href="#!">
                            <div class="am-u-sm-6 award-goods">
                                <img src="https://p8r7m4d5.stackpathcdn.com/images//webimgs/n20191211110625958.jpg">
                            </div>
                            <div class="am-u-sm-6 award-info-box">
                                <div class="goods-name">CATISS We Can Love 禮盒5件組 小資副食系列 唇膏任選CATISS We Can Love 禮盒5件組 小資副食系列 唇膏任選</div>
                                <h5 class="goods-qty">Final Qty:
                                            <span>25</span>
                                </h5>
                            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#randomizeButton").on('click',function () {
                ...
                if (u == null) {
                    location.href = "login.aspx?rurl=jackpot_game.aspx";
                } else {
                    var type = '<%=HFSt.Value%>';
                    switch (type) {
                        ...
                        case '1':
                            ...
                            setTimeout(function () {//For Mobile
                                $('.redeem-ticket').animate({
                                    bottom: '11%',
                                    width: '50%'
                                }).css('display', 'block');
                            }, 5000);
                            //$('.redeem-ticket').addClass('fell-out');

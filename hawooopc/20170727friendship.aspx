<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20170727friendship.aspx.cs" Inherits="user_20170727friendship" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20170727friendship.aspx";
                }
            }
        }
         )
    ...
    <div class="am-show-md-up">
        <div class="fullBanner">
            <a href="#" target="_blank">
                <img src="https://www.hawooo.com/images/ftp/20170727/edm-pc.png" alt="Supermama Day2"></a>
        </div>
    </div>
    <div class="am-show-sm">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20170727/edm-mb.png" alt="Supermama Day2">
        </div>
    </div>

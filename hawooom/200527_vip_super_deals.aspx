<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200527_vip_super_deals.aspx.cs" Inherits="mobile_static_200527_vip_super_deals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div class="am-g main-contain mb-contain" id="top" style="background:#FFB740;">
    <div>
      <img src="https://p8r7m4d5.stackpathcdn.com/images/ftp/20200527/bn_02m.png" alt="main-banner" />
    </div>
      ...
      <div class="am-padding-bottom-sm am-padding-horizontal-xs">
        <ul class="am-avg-sm-2">
          <li class="am-padding-xs coupon">
            ...
            <h6 class="coupon-code">code123</h6>
          </li>
          <li class="am-padding-xs  coupon">

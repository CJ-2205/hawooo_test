...
public partial class user_MidYearSalePreOrder : System.Web.UI.Page
{
    private int eid = int.Parse(Resources.PreOrderRes.SelID.ToString());
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        if (DateTime.Now >= Convert.ToDateTime("2019-09-27 00:00:00"))
        {
            Response.Redirect("MidYearFs.aspx");
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("../mobile/" + Resources.PreOrderRes.Url.ToString());
            }
            BindProductList(eid);
            BindAddList();
        }

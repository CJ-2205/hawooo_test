<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20170815pageD.aspx.cs" Inherits="user_20170815pageD" %>
        ...
        $(function () {
            ...
            for (var v = 0; v < userAgentKeywords.length; v++) {
                if (userAgentInfo.indexOf(userAgentKeywords[v]) > 0) {
                    window.location.href = "https://www.hawooo.com/mobile/20170815pageD.aspx";
                }
            }
        }
         )
    ...
    <div class="am-show-md-up">
        <div class="fullBanner">
            <a href="" target="_blank">
                <img src="https://www.hawooo.com/images/ftp/20170815/0815D_01.png" alt="All below RM60"></a>
        </div>
    </div>
    <div class="am-show-sm">
        <div class="fullBanner">
            <img src="https://www.hawooo.com/images/ftp/20170815/dm_01.png" alt="All Below RM60">
        </div>
    </div>
    ...
    <div class="am-show-md-up" style="width: 100%; margin-bottom: -2px; float: left; display: block; max-width: 1920px;">
        <ul style="float: left; margin: 0; padding: 0; list-style-type: none; font-size: 0; width: 100%;">
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8904" target="_blank">
                <img alt="【婦潔VIGILL】私密高效美白凝露 30ml" src="https://www.hawooo.com/images/ftp/20170815/0815d_03.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=7682" target="_blank">
                <img alt="【Miss Hana花娜小姐】妝素顏透亮賴床霜 30ml" src="https://www.hawooo.com/images/ftp/20170815/0815d_04.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=8348" target="_blank">
                <img alt="NEWART 水芹控油淨化精華 120ml" src="https://www.hawooo.com/images/ftp/20170815/0815d_05.png" style="float: left; display: block; width: 50%;" /></a></li>
            <li style="margin: 0;"><a href="https://www.hawooo.com/user/productdetail.aspx?id=3615" target="_blank">
                <img alt="Anden Hud 低腰三角褲 6入(隨機) Ｍ/L/XL" src="https://www.hawooo.com/images/ftp/20170815/0815d_06.png" style="float: left; display: block; width: 50%;" /></a></li>

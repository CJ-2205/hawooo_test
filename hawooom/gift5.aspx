<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="gift5.aspx.cs" Inherits="gift5" %>
    ...
    <div>
        ...
        <div class="am-u-sm-centered" style="position: fixed; bottom: 0; left: 50%; max-width: 650px; text-align: center; transform: translate(-50%); z-index: 999;">
            <ul class="am-avg-sm-4 am-cf" style="list-style-type: none; padding: 0; margin: 0;">
                <li class="am-fl">
                    <a href="gift2.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171201/sec_02.png" style="width: 100%;" alt="越吃越美麗"></a></li>

                <li class="am-fl">
                    <a href="gift3.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171201/sec_03.png" style="width: 100%;" alt="吃貨最挑嘴"></a></li>

                <li class="am-fl">
                    <a href="gift1.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171201/sec_01.png" style="width: 100%;" alt="跑趴我最正"></a></li>

                <li class="am-fl">
                    <a href="gift4.aspx" style="display: inline">
                        <img src="https://www.hawooo.com/images/ftp/20171201/sec_04.png" style="width: 100%;" alt="心肝寶最愛"></a></li>
        ...
        <div class="am-show-sm">
            <div class="fullBanner">
                <img src="https://www.hawooo.com/images/ftp/20171201/edmm_18.png" alt="伸展台穿搭"></div>
        </div>

...
public partial class user_static_200803_88shopping_bundlesale : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200803_88shopping_bundlesale.aspx" + Request.Url.Query);
            }

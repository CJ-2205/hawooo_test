<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa04.aspx.cs" Inherits="user_qa04" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">如何查看Ha幣和購物金呢？</h4>
                <div class="qa-main">
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">How can I check the Ha Coin and HaWooo shopping credit?</h4>
                <div class="qa-main">
                    <h5 class="qa-step">‧<p class="qa-step-title-eng">After log in, it will show the Ha Coin and HaWooo shopping credit at the left side.</p>
                    </h5>

                    <h5 class="qa-step">‧<p class="qa-step-title-eng">Click the Ha Coin and HaWooo shopping credit, it will show the balance and the expired date of the Ha Coin in your account.</p>
                    </h5>

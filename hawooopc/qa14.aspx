<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa14.aspx.cs" Inherits="user_qa14" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">如何計算運費？</h4>
                <div class="qa-main">
                    <h5 class="qa-step">‧<p class="qa-step-title">西馬RM 19。</p>
                    </h5>
                    <h5 class="qa-step">‧<p class="qa-step-title">東馬RM 25。</p>
                    </h5>
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">Shipping fees</h4>
                <div class="qa-main">
                    <h5 class="qa-step">‧<p class="qa-step-title-eng">West Malaysia RM 19.</p>
                    </h5>
                    <h5 class="qa-step">‧<p class="qa-step-title-eng">East Malaysia RM 25.</p>
                    </h5>

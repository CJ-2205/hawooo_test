<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2019womenbuy_3.aspx.cs" Inherits="mobile_2019womenbuy_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black; position: relative">
        <a href="#" id="coupon1" data-clipboard-text="BEAUTY15" onclick="Clip('coupon1');">
            <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190711/bn_01m.png" %>' style="float: left; display: block; width: 100%;" /></a>

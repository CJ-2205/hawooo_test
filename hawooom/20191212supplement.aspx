<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20191212supplement.aspx.cs" Inherits="mobile_static_20191212supplement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g  main-contain">
        <div class="am-container">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191202/bbn_05.png" %>' alt="bbn_05" style="width: 100%;" />
            </div>
            <section>
    ...
    <script>
        $(function hrefChange() {
            ...
            var date3 = new Date("2019/12/12 12:00:00");

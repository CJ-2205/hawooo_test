...
public partial class user_static_200709beauty_sale_flashsale : System.Web.UI.Page
{
    public int serverType = 0;
    public string cacheVersion = "7";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200709beauty_sale_flashsale.aspx" + Request.Url.Query);
            }
    ...
    {
        datePreorderEnd = toggleSvr<string>(serverType, "2020-07-11 23:59:59", "2020-07-08 22:45:00") ;
        dateFlashsaleEnd = toggleSvr<string>(serverType, "2020-07-15 23:59:00", "2020-07-08 23:50:00") ;

        optionFlashSale.Add("webControlIds", rpFlashSale);
        optionFlashSale.Add("eventId", toggleSvr<int>(serverType, 1040, 798));
        optionFlashSale.Add("take", toggleSvr<int>(serverType, 0, 7));

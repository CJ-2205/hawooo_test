<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="gift3.aspx.cs" Inherits="gift3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <li class="am-fl">
   <a href="gift2.aspx" style="display: inline"><img src="https://www.hawooo.com/images/ftp/20171201/sec_02.png" style="width:100%;" alt="越吃越美麗"></a></li>
  ...
  <div class="fullBanner"><img src="https://www.hawooo.com/images/ftp/20171201/edmm_14.png" alt="吃貨最挑嘴"></div>
</div>
      <!--系統開始帶商品-->
        <!--下方商品-->
        <div style="padding-bottom:10px;max-width:100%;background-color:#dc4d3f">

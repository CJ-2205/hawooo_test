<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200618mys2_hot_deal.aspx.cs" Inherits="mobile_static_200618mys2_hot_deal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #A63B24;">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/bbn_05m.png" %>' alt="main-banner" />
        </div>
                ...
                <ul class="am-avg-sm-2">
                    ...
                    <li class="am-padding-xs coupon">
                        <a class="btnn " data-clipboard-text="MID65">
                            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/coupon_03.png" %>' alt="coupon_03" />
                        </a>
                        <div class="coupon-code">
                            <h6 class="am-margin-top-xs"><span>
    ...
    <div class="footer-bar a">
        <div>
            <ul class="am-avg-sm-4 flash-sale-display1">
                <li>
                    <a href="200618mys2.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_00m.png?v=1" %>' alt="ss_00m" />
                    </a>
                </li>
                <li>
                    <a href="200618mys2_flash_sale.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_01m.png?v=1" %>' alt="ss_01m" />
                    </a>
                </li>
                <li>
                    <a href="#!">
                ...
                <li>
                    <a href="200618mys2.aspx">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_04m.png?v=1" %>' alt="ss_04m" /></a>
                </li>
                <li>
                    <a href="200618mys2.aspx?#s4" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_05m.png?v=1" %>' alt="ss_05m" /></a>
                </li>
                <li>
    ...
    <div class="footer-bar">
        <div>
            <ul class="am-avg-sm-3 flash-sale-display2">
                <li>
                    <a href="200618mys2.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200618/ss_00m_ch.png" %>' alt="ss_00m_ch" />
                    </a>
                </li>
                <li>
                    <a href="#!">

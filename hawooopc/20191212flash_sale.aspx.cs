...
public partial class user_static_20191212flash_sale : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/20191212flash_sale.aspx" + Request.Url.Query);
            }
            BindGoods();
        }
    }
    ...
    public DataTable GetRealStock(int eid)
    {
	  ...
	  WHERE ORM24>=0 AND ORM03>='2019-12-12 00:00:00' GROUP BY ORD01";
        SqlCommand cmd = new SqlCommand();

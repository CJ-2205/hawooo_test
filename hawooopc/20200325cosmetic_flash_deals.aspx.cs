...
using System.Text;
public partial class user_static_20200325cosmetic_flash_deals : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        bool ismobile = PbClass.IsMobile();
        if (ismobile)
            Response.Redirect("../mobile/20200325cosmetic_flash_deals.aspx" + Request.Url.Query);

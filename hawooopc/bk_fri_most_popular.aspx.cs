...
public partial class user_static_bk_fir_most_popular : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/bk_fir_most_popular.aspx" + Request.Url.Query);
            BindData();
        }
    }

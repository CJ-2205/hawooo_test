<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qat07.aspx.cs" Inherits="user_qat07" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">Terms</h4>
                <div class="qa-index">
                    <ul>
                        <li class="qa-text-index-title"><a href="qa31.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            Terms of Service</a></li>

                        <li class="qa-text-index-title"><a href="qa34.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            Privacy Policy</a></li>
                    </ul>
                </div>

...
public partial class user_static_200710supplement_buy1free1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200710supplement_buy1free1.aspx" + Request.Url.Query);
            }
    ...
    public void setOptions()
    {
        ...
        optionBuy1free1.Add("take", toggleSvr<int>(serverType, 0, 7));

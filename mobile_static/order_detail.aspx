<%@ Page Title="" Language="C#" MasterPageFile="~/mobile_static/m.master" AutoEventWireup="true" CodeFile="order_detail.aspx.cs" Inherits="mobile_static_order_detail" %>
                ...
                <div class="am-g am-g-collapse">
                    <div class="am-u-sm-9 order-specs-col">
                        <ul class="order-specs-data-list">
                            <li><span class="txtRsc" data-id="m001">Order Date：</span> <span>2020/9/11 下午12:00:00</span></li>
                            <li><span class="txtRsc" data-id="m002">Order No：</span> <span>S200911120103011</span></li>
                        </ul>
                    </div>
                    <div class="am-u-sm-3 order-specs-col order-specs-col-status">
                        <span class="order-specs-status">Shipping</span>
                    </div>
                </div>
            </div>
            <!-- 尾款訂單編號與狀態 (End)-->
...
<!-- 【尾款付款狀態】Payment Info(Start) -->
                ...
                <div class="am-g am-g-collapse order-specs-row fs-0">
                    ...
                    <div class="am-u-sm-10 order-specs-col order-specs-col-payment">
                        <ul>
                            ...
                            <li><strong>Payment Status：</strong> <span>Deposit Paid
                            </span>
                            </li>
                        </ul>
                    </div>
             ...
             <div class="am-panel-bd">
                <div class="am-g am-g-collapse order-specs-row fs-0">
                    ...
                    <div class="am-u-sm-10 order-specs-col order-specs-col-payment">
                        <ul>
                            <li><strong>Payment Method :</strong> <span>Moplay</span></li>
                            <li><strong>Payment Status：</strong> <span>Final Payment Paid
                            </span>
                            </li>
                        </ul>
                    </div>
   ...
   <!-- Back My Orders Button (Start)-->
    <section class="bg-white py-3 order-specs-bottom-btn-section">
        <div class="am-g">
            <div class="am-u-sm-12">
                <div class="d-flex">
                    <a href="#" class="am-btn btn-primary btn-block">Back My Orders
                    </a>
                </div>
            </div>
        </div>
    </section>
   <!-- Back My Orders Button (end)-->
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qat06.aspx.cs" Inherits="user_qat06" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">Price Comparison</h4>
                <div class="qa-index">
                    <ul>
                        <li class="qa-text-index-title"><a href="qa19.aspx">
                            <img src="https://www.hawooo.com/images/ftp/test/tasklist.png" class="qa-taskicon" />
                            What is HaWooo Price Comparison Service?</a></li>
                    </ul>
                </div>
            </div>
            <!-- 右方內容 qa-content end -->

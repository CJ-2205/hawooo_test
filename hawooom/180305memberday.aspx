<%@ Page Language="C#" AutoEventWireup="true" CodeFile="180305memberday.aspx.cs" Inherits="_180305memberday" MasterPageFile="~/mobile/mobile.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #261010;">
        ...
        <img alt="VIP" src="https://www.hawooo.com/images/ftp/20180305/edmm_01.png" style="float: left; display: block; width: 100%;" />

        <img alt="抽一名訂單免費" src="https://www.hawooo.com/images/ftp/20180305/edmm_02.png" style="float: left; display: block; width: 100%;" />
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px;">
        ...
        <img alt="hawooo.com" src="https://www.hawooo.com/images/ftp/20180305/edmm_03.png" style="float: left; display: block; width: 100%;" />
    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddToCartToNewMember.aspx.cs" Inherits="Webform_AddToCartToNewMember" %>

<!DOCTYPE html>
<!--
    購物車提醒信
標題：Hi 你爱的商品正在特价 快帶它回家

發送條件：加入購物車 24後尚未結帳時發送 

(ps.兩個檔案，一個是給舊客的。一個是給新客戶。)   @leo

信件中推薦熱銷商品條件：
1.前一個月美體保養類熱賣TOP 1 （目前仍然上架）
2.前一個月時尚美妝類熱賣TOP 1 （目前仍然上架）
3.前一個月食物熱賣TOP 1 （目前仍然上架）
4.前一個月生活類熱賣TOP 1 （目前仍然上架）-->
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
            ...
            <div style="width: 80%">
                ...
                <div>
                    <a href="https://www.hawooo.com/user/index.aspx?utm_source=email&utm_medium=edm&utm_campaign=cart_reminder&utm_content=cart_reminder%20-%20A" target="_blank">
                        <img alt="RM 15 Free Shipping" src="https://www.hawooo.com/images/ftp/20171113member/maksaa_02_02.png" style="float: left; display: block; width: 100%;" /></a>
                </div>

                <div>
                    <img alt="你愛的商品正在特價" src="https://www.hawooo.com/images/ftp/20171113member/maksaa_03_02.png" style="float: left; display: block; width: 100%;" />
                </div>
           ...
           <a href="https://www.hawooo.com/user/productdetail.aspx?id=*|ID1|*utm_source=email&utm_medium=edm&utm_campaign=cart_reminder&utm_content=cart_reminder%20-%20A" target="_blank" style="text-decoration: none;">
                        <div style="max-width: 650px;max-height: 218px;float: left;background-color: white;">
                            <div style="width: 198px;float: left;margin: 0;padding: 10px 0 10px 10px;height:198px;">
                                <img src="https://www.hawooo.com/images/webimgs/*|PIC1|*" alt="img" style=" width: 178px;max-width: 220px;padding: 5%;" />
                            </div>
          ...
          <a href="https://www.hawooo.com/user/productdetail.aspx?id=*|ID2|*utm_source=email&utm_medium=edm&utm_campaign=cart_reminder&utm_content=cart_reminder%20-%20A" target="_blank" style="text-decoration: none;*|HIDDEN2|*">
                        <div style="max-width: 650px;max-height: 218px;float: left;background-color: #f8f8f8;">
                            <div style="width: 198px;float: left;margin: 0;padding: 10px 0 10px 10px;height:198px;">
                                <img src="https://www.hawooo.com/images/webimgs/*|PIC2|*" alt="img" style=" width: 178px;max-width: 220px;padding:5%;" />
                            </div>
                            <div style="width: 292px;float: left;margin: 0;padding: 10px 0 10px 20px;height:126px;">
                        ...
                        <div style="max-width: 650px;max-height: 218px;float: left;background-color: white;">
                            <div style="width: 198px;float: left;margin: 0;padding: 10px 0 10px 10px;height:198px;">
                                <img src="https://www.hawooo.com/images/webimgs/*|PIC3|*" alt="img" style=" width: 178px;max-width: 220px;padding: 5%;" />
                            </div>
                            <div style="width: 292px;float: left;margin: 0;padding: 10px 0 10px 20px;height:126px;">
         ...
         <%--                        
               <a href=" " target="_blank" style="text-decoration: none;">
                        <div style="max-width: 650px;max-height: 218px;float: left;background-color: white;">
                            <div style="width: 198px;float: left;margin: 0;padding: 10px 0 10px 10px;height:198px;">
                                <img src="*|PIC1|*" alt="商品圖" style=" width: 100%;max-width: 220px;padding: 5%;" />
                            </div>
                            <div style="width: 292px;float: left;margin: 0;padding: 10px 0 10px 20px;height:126px;">
                                <span style=" font-size: 100%;line-height: 130%;font-weight: bold;overflow: hidden;float: left;text-align: left;font-family: Arial,Helvetica,sans-serif;color: #3a3a3c;padding: 2%;">*|NAME1|*</span>
                                <p style="font-size: small;color: #ed147f;margin: 5% 0 0 0;font-weight: bold;padding-top: 50px;">RM<span style=" font-size: 250%;">*|PRICE1|*</span><del style="color: #939598;font-size: 100%;">100.00</del></p>
                   ...
                   <a href=" " target="_blank" style="text-decoration: none;">
                        <div style="max-width: 650px;float: left;background-color: white;">
                            <div style="width: 40%;float: left;margin: 0;padding: 10px 0 10px 10px;">
                                <img src="*|PIC1|*" alt="商品圖" style=" width: 100%;max-width: 220px;padding: 5%;" />
                            </div>
                            <div style="width: 60%;float: left;margin: 0;padding: 10px 0 10px 20px;">
                                <span style=" font-size: 100%;line-height: 130%;font-weight: bold;overflow: hidden;float: left;text-align: left;font-family: Arial,Helvetica,sans-serif;color: #3a3a3c;padding: 2%;">*|NAME1|*</span>
                                <p style="font-size: small;color: #ed147f;margin: 5% 0 0 0;font-weight: bold;padding-top: 50px;">RM<span style=" font-size: 250%;">*|PRICE1|*</span><del style="color: #939598;font-size: 100%;">100.00</del></p>

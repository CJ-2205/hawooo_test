<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200514_rayasale_valuebuy.aspx.cs" Inherits="mobile_static_200514_rayasale_valuebuy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g main-contain mb-contain" id="top" style="background: #BD6B08;">
        <div>
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200514/bbn_02m.png" %>' alt="main-banner" />
        </div>
        ...
        <section class="am-margin-bottom" id="s1">
            ...
            <div style="background: #1A1425;">
                ...
                <div class="am-padding-vertical">
                    ...
                    <a class="am-u-sm-5 am-u-md-4 am-block am-u-sm-centered" onclick="displayProduct();">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200514/more.png" %>' alt="more" />
                    </a>
                </div>
            </div>

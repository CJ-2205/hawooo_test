...
public partial class user_static_200409super_brands : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/200409super_brands.aspx" + Request.Url.Query);
    ...
    public List<BrandInfo> listBrand()
    {
        ...
        listBrandsInfo.Add(new BrandInfo(439, url + 439.ToString(), "全館 UP TO 20% OFF", cm + "ftp/20200402/logo_04_05.png", 4, 5, cm + "ftp/20191127/aw_05.png"));

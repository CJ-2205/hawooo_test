...
public partial class user_static_2020valentines_day_best_gifts : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (ismobile)
                Response.Redirect("../mobile/2020valentines_day_best_gifts.aspx" + Request.Url.Query);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="angpao3.aspx.cs" Inherits="angpao3" MasterPageFile="~/mobile/mobile.master"%>
  ...
  <link rel="stylesheet" href="assets/css/newyearmom.css">--%>
    <div>
        ...
        <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #eb3a27">
            <a href="angpao3.aspx" target="_blank">
        <img alt="家裡就有髮型師" src="https://www.hawooo.com/images/ftp/20180116/edmm_15.gif" style="float:left;display:block;width:100%;" /></a>

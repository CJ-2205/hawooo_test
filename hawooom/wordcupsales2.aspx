<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="wordcupsales2.aspx.cs" Inherits="mobile_wordcupsales2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; max-width: 650px; z-index: 1; margin: 0 auto; margin-bottom: -1px;">
        <img id="gotop" src="https://www.hawooo.com/images/ftp/20180706/pro/edmm_01.png" style="width: 100%" alt="優惠商品">

        <div class="btnn btnns" data-clipboard-text="worldcup20"></div>

        <img src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_02.png" style="width: 100%">
    ...
    <div style="max-width: 650px; background-color: #000b04; margin: 0 auto;">
        <img id="gosale1" alt="熬夜看世足" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_03.png" style="float: left; display: block; width: 100%;" />

        <div class="am-cf" style="max-width: 585px; background-color: #013104; margin: 0 auto;">
        ...
        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=48" target="_blank">
            <img alt="生活看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_05.png" style="float: left; display: block; width: 33.3%;" /></a>

        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=43" target="_blank">
            <img alt="保健看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_06.png" style="float: left; display: block; width: 33.3%;" /></a>

        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=47" target="_blank">
            <img alt="美食看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_07.png" style="float: left; display: block; width: 33.3%;" /></a>
    ...
    <div style="max-width: 650px; background-color: #000b04; margin: 0 auto;">
        <img id="gosale2" alt="自然系美女" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_08.png" style="float: left; display: block; width: 100%;" />

        <div class="am-cf" style="max-width: 585px; background-color: #84250e; margin: 0 auto;">
        ...
        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=42" target="_blank">
            <img alt="保養看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_10.png" style="float: left; display: block; width: 50%;" /></a>

        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=16" target="_blank">
            <img alt="美妝看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_11.png" style="float: left; display: block; width: 50%;" /></a>
    ...
    <div style="max-width: 650px; background-color: #000b04; margin: 0 auto;">
        <img id="gosale3" alt="運動風混搭" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_12.png" style="float: left; display: block; width: 100%;" />

        <div class="am-cf" style="max-width: 585px; background-color: #0d4c69; margin: 0 auto;">
        ...
        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=44" target="_blank">
            <img alt="內衣看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_14.png" style="float: left; display: block; width: 33.3%;" /></a>

        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=46" target="_blank">
            <img alt="包包看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_15.png" style="float: left; display: block; width: 33.3%;" /></a>

        <a href="http://www.hawooo.com/mobile/shop.aspx?cid=45" target="_blank">
            <img alt="鞋子看更多" src="https://www.hawooo.com/images/ftp/20180629/pro/edmm_16.png" style="float: left; display: block; width: 33.3%;" /></a>

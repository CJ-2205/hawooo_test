<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="200604mys1_buy1free1.aspx.cs" Inherits="user_static_200604mys1_buy1free1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="am-g main-contain">
            ...
            <ul>
                ...
                <li>
                    <a href="200604mys1_hot_deal.aspx" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_01.png" %>' alt="ss_01" /></a>
                </li>
                <li>
                    <a href="#!">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_02.png" %>' alt="ss_02" /></a>
                </li>
                <li>
                    <a href="200604mys1.aspx?#s3" target="_blank">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_03.png" %>' alt="ss_03" /></a>
                </li>
                <li>
                    <a onclick="goto('s4')">
                        <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/ss_04.png" %>' alt="ss_04" /></a>
                </li>
                <li onclick="goto('s5')">
        ...
        <div class="am-container">
            <div>
                <img class="am-margin-bottom-xl" src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200604/bbn_02.png" %>' alt="bbn_02" />
            </div>
            ...
            <%--Block2 (Start) ======================================================--%>
            <div class="am-margin-bottom-xl am-padding-sm shop-block" style="background: #067C99;">
                <ul class="am-avg-sm-4">
                    <%--後端帶入商品 (Start) --%>

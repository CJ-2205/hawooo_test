...
public partial class _MemberDay : System.Web.UI.Page
{

    DateTime eventStart = new DateTime(2018, 06, 12, 00, 00, 00);
    DateTime eventEnd = new DateTime(2018, 06, 14, 23, 59, 59);
    ...
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        if (today > eventStart && today < eventEnd)
        {
            ...
            if (isMobile)
            {
                ...
                Response.Redirect("../mobile/memberday.aspx" + qstr);
            }
        }
        else
        {

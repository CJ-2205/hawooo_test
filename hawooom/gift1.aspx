<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true"
    CodeFile="gift1.aspx.cs" Inherits="gift1" %>
...
<%--         <link rel="stylesheet" href="assets/css/amazeui.min.css">
  ...
  <div class="fullBanner"><img src="https://www.hawooo.com/images/ftp/20171201/edmm_10.png" alt="跑趴我最正"></div>
</div>

   
  <!--系統開始帶商品-->
        <!--下方商品-->
        <div style="padding-bottom:10px;max-width:100%;background-color:#4aa940">

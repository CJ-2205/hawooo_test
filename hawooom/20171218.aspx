<%@ Page Language="C#" AutoEventWireup="true" CodeFile="20171218.aspx.cs" MasterPageFile="~/mobile/mobile.master" Inherits="_17_12_17_FoodEDM_mobile_20171218" %>
    ...
    <script>
        $(document).ready(function () {
            if (document.body.clientWidth < 530) {
                ...
                window.location.href = "https://www.hawooo.com/user/shop.aspx?eid=328";
...
<div class="am-show-sm">
  <div class="fullBanner"><img src="https://www.hawooo.com/images/ftp/20171219/edmM.png" alt="吃貨編推薦"></div>
</div>

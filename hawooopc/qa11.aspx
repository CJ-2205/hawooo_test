<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="qa11.aspx.cs" Inherits="user_qa11" %>
    ...
    <div style="margin-top: 120px; display: block;">
        ...
        <section class="am-container qa-wrapper" id="zhPanel" runat="server">
            ...
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">如何註冊帳號?</h4>
                <div class="qa-main">
                    <h5 class="qa-step">1‧)<p class="qa-step-title">點選首頁右上方的「會員註冊(Register)」。</p>
                    </h5>
                    <img class="qa-answer-img" src="https://www.hawooo.com/images/ftp/test/qa11p1.png">

                    <h5 class="qa-step">2‧)<p class="qa-step-title">填寫所需資料並且打勾「我同意HaWooo會員條款」，然後點擊「加入會員」，即完成註冊。</p>
                    </h5>
                    <img class="qa-answer-img" src="https://www.hawooo.com/images/ftp/test/qa11p2.png">
                </div>
        ...
        <section class="am-container qa-wrapper" id="enPanel" runat="server">
            ...
            <!-- 右方內容 qa-content start -->
            <div class="qa-content">
                <h4 class="qa-height qa-maintitle">How to register an account?</h4>
                <div class="qa-main">
                    <h5 class="qa-step">1‧)<p class="qa-step-title-eng">Click the "Register" button on the upper right corner.</p>
                    </h5>
                    <img class="qa-answer-img" src="https://www.hawooo.com/images/ftp/test/qa11p1.png">

                    <h5 class="qa-step">2‧)<p class="qa-step-title-eng">
                        Fill up your username, password and your email, and click yes the
term of condition for membership.
                    </p>
                    </h5>
                    <img class="qa-answer-img" src="https://www.hawooo.com/images/ftp/test/qa11p2.png">
                </div>

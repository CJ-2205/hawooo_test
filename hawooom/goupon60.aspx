<%@ Page Language="C#" AutoEventWireup="true" CodeFile="goupon60.aspx.cs" Inherits="_goupon60" MasterPageFile="~/mobile/mobile.master" %>
            ...
            if (bool == 'true') {
                $.ajax({
                    ...
                    success: function (response) {
                        debugger;
                        alert2url(response.d, "https://www.hawooo.com/mobile/180430lovemom.aspx");         //here
                    },
                    error:
                    function (response) {
                        debugger;
                        alert2url("Oh No,系統好像出現了問題,若多次無法使用請麻煩與客服聯繫。", "https://www.hawooo.com/mobile/goupon60.aspx");     //here
                    }
                })
            }
            else {
                window.location = "login.aspx?rurl=goupon60.aspx";         //here
            }
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; position: relative; z-index: 5; margin: 0 auto">

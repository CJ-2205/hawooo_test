<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ttm15.aspx.cs" Inherits="_180601tt" MasterPageFile="~/user/user.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!--神奇圖層區開始-->
    <div style="width: 100%; position: relative; width: 1000px; z-index: 1; margin: 0 auto; display: block;">
        <img id="gotop" src="https://www.hawooo.com/images/ftp/20180601/ttm_edm_01.png" alt="排行榜" style="width: 100%">


        <asp:UpdatePanel ID="up_product_coupon" runat="server">
            <ContentTemplate>
                <div style="width: 50%; display: block; z-index: 2; top: 0; bottom: 0; left: 0; right: 0; display: block; float: left">
                    <asp:ImageButton  ID="ImageButton1" runat="server" ImageUrl="https://www.hawooo.com/images/ftp/20180601/coupon-ttm15.png" CssClass="go_bt btnn" OnClick="CpnBtn_Click" />
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <div style="width: 50%; z-index: 2; margin: 0 auto; display: block; float: left">
            <img src="https://www.hawooo.com/images/ftp/20180601/ttm_edm_02.png" alt="活動辦法" style="width: 100%; height: 100%" />
        </div>
    </div>

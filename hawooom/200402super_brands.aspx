<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="200402super_brands.aspx.cs" Inherits="mobile_static_200402super_brands" %>
                            ...
                            <ItemTemplate>
                                <li class="am-fl swiper-slide">
                                    <div class="super-brand-item" data-id='<%# Eval("BID") %>'>
                                        <label for='<%# Eval("BID") %>' class="vote-label choose-vote" />

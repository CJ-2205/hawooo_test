...
{
    private int letterWidth = 20;//單個字體的寬度範圍  
    private int letterHeight = 32;//單個字體的高度範圍  
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["vcode"] = str_ValidateCode;
    ...
    public void CreateImage(string checkCode)
    {
        ...
        for (int int_index = 0; int_index < checkCode.Length; int_index++)
        {
            ...
            g.DrawString(str_char, new Font(fonts[findex], 14, FontStyle.Regular), newBrush, thePos);
        }
        //灰色邊框  

...
public partial class user_static_200716friendship_hotdeal : System.Web.UI.Page
{
    ...
    public void setOptions()
    {
        ...
        dateHotDealStage2End = SwitchServer<string>(serverType, "2020-07-31 23:59:59", "2020-07-31 20:00:00");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ismobile)
            {
                Response.Redirect("../mobile/200716friendship_hotdeal.aspx" + Request.Url.Query);
            }

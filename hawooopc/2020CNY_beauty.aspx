<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2020CNY_beauty.aspx.cs" Inherits="user_static_2020CNY_beauty" %>
    ...
    <div class="am-g main-contain am-padding-vertical-lg">
        <section class="am-container ">
            <div class="banner-box">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200110/bbn_03.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>
            <div class="banner-box am-padding-vertical">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200110/free_01.png" %>' alt="bbn_03" style="width: 100%;" />
            </div>

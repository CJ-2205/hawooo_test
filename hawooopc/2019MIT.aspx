<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="2019MIT.aspx.cs" Inherits="user_2019MIT" %>
    ...
    <div class="am-container">
        ...
        <div class="am-g">
            <a id="coupon1" data-clipboard-text="MIT30" onclick="Clip('coupon1');">
                <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20190906/MIT_bn-01.png" %>' style="width: 100%" />
            </a>
        </div>
        ...
        <%--<div class="am-g">
            <div class="am-u-sm-12" style="padding: 0px">
                <a id="coupon1" data-clipboard-text="supplements60" onclick="Clip('coupon1');">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/collections/2coupon_01.png" %>' style="width: 100%" />
                </a>
            </div>
        </div>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="useless_treegb.aspx.cs" Inherits="user_static_200514_rayasale" %>
    ...
    <div class="am-g main-contain" style="background: #BD6B08;">
        ...
        <div class="am-container">
          ...
          <div class="testing-block">
            ...
            <asp:Label ID="TreegbLabel1" runat="server"></asp:Label>
            <asp:Label ID="TreegbLabel2" runat="server"></asp:Label>
            <hr />
            <section>
            <div class="am-padding pc-slider">
              <div class="swiper-container swiper-container7">
                <ul class="swiper-wrapper">
                  <uc1:products runat="server" id="TreegbUc1" />
                </ul>
              </div>
            </section>
          </div>

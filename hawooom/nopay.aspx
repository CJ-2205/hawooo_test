<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="nopay.aspx.cs" Inherits="mobile_nopay" %>
    ...
    <script>
        function go2order() {
            ...
            if (u != "null")
                ...
                location.href = 'login.aspx?rurl=memberorder.aspx';
        }
    </script>
</asp:Content>

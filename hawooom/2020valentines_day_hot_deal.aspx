<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2020valentines_day_hot_deal.aspx.cs" Inherits="mobile_static_2020valentines_day_hot_deal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-g  main-contain">
        <div class="banner-box">
            <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200204/bbn_01m.png" %>' alt="bbn_01m" style="width: 100%;" />
        </div>
        <section>

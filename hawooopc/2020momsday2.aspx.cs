...
using hawooo;
public partial class user_static_2020momsday2 : System.Web.UI.Page
{
    //private string str_preorder_start_time = "2020-05-05 00:00:00";
    //private string str_flash_start_time = "2020-05-10 00:00:00";
    //private string str_flash_end_time = "2020-05-12 00:00:00";
    //private int eid = 949;

    //測試版專用
    private string str_preorder_start_time = "2020-07-05 00:00:00";
    private string str_flash_start_time = "2020-12-10 00:00:00";
    private string str_flash_end_time = "2020-12-12 00:00:00";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ismobile)
            Response.Redirect("../mobile/2020momsday2.aspx" + Request.Url.Query);
        if (!IsPostBack)
        {
            BindProductList(eid);
            SetPanel();

<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="20191111catch_up_sale.aspx.cs" Inherits="user_static_20191111catch_up_sale" %>
        ...
        <div class="am-margin-vertical-lg">
            <section class="shop-block-wrap am-container">
                <div class="banner-box  am-text-center  am-padding-vertical-sm">
                    <img src='<%= ConfigurationManager.AppSettings["imgUrl"] + "ftp/20191112/bbn_02.png" %>' alt="bbn_03" style="width: 100%;" />
                </div>

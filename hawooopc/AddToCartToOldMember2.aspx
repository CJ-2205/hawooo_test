<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddToCartToOldMember2.aspx.cs" Inherits="AddToCartToOldMember2" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 100%; margin: 0 auto; float: left; display: block; max-width: 650px;">
            ...
            <div style="width: 80%">
                ...
                <!--內容開始-->
                <div>
                    <img alt="你愛的商品正在特價" src="https://www.hawooo.com/images/ftp/20171113member/maksaa-old2_02_02.png" style="float: left; display: block; width: 100%;" />
                </div>
          ...
          <a href="https://www.hawooo.com/user/productdetail.aspx?id=*|ID2|*&tcode=hawooomembers4&utm_source=email&utm_medium=20171130_all_hawooomembers4_%E5%8A%A0%E5%85%A5%E8%B3%BC%E7%89%A9%E8%BB%8A&utm_content=m0070" target="_blank" style="text-decoration: none;*|HIDDEN2|*">
             ...
             <!--猜你也愛開始-->
                <div style="margin: 0;">
                    <img alt="猜你也愛" src="https://www.hawooo.com/images/ftp/20171113member/maksaa-old2_04_02.png" style="float: left; display: block; width: 100%;" />
                </div>
                <!--猜你也愛 帶商品吧-->
                <div>

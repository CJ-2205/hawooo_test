<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="20191111preorder.aspx.cs" Inherits="mobile_20191111preorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section>
        <div>
            <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/bn_03m.png" style="width: 100%" />
        </div>
    ...
    <div style="background-color: #dfdfdf;">
        ...
        <section class="am-margin-vertical-sm" id="f1">
            <div>
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/f_01m.png" style="width: 100%" />
            </div>
        </section>

        <section id="s_product_list" class="am-g proudctListPanel" style="background-color: #2B2740">
                        ...
                        <li>
                            <div class="pitem" id="item_<%# Eval("WP01") %>">
                                ...
                                <div style="padding-top: 5px">
                                    <input type="button" value="Add to Wishlist" class="button1" onclick="BookingEvent('item_<%# Eval("WP01") %>');" />
                                </div>
                            </div>
                        </li>
                    </ItemTemplate>
        ...
        <section style="background-color: #2B2740">
            <div id="more1" class="am-margin-sm more-block">
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/more_01m.png" style="width: 100%" />
            </div>
        </section>

        <section class="am-margin-vertical-sm" id="f2">
            <div>
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/f_02m.png" style="width: 100%" />
            </div>
        </section>

        <section id="s_product_list2" class="am-g proudctListPanel" style="background-color: #2B2740">
        ...
        <section style="background-color: #2B2740">
            <div id="more2" class="am-margin-sm more-block">
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/more_01m.png" style="width: 100%" />
            </div>
        </section>

        <section class="am-margin-vertical-sm" id="f3">
            <div>
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/f_03m.png" style="width: 100%" />
            </div>
        </section>

        <section id="s_product_list3" class="am-g proudctListPanel" style="background-color: #2B2740">
        ...
        <section style="background-color: #2B2740">
            <div id="more3" class="am-margin-sm more-block">
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/more_01m.png" style="width: 100%" />
            </div>
        </section>


        <section class="am-margin-vertical-sm" id="f4">
            <div>
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/f_04m.png" style="width: 100%" />
            </div>
        </section>

        <section id="s_product_list4" class="am-g proudctListPanel" style="background-color: #2B2740">
        ...
        <section style="background-color: #2B2740">
            <div id="more4" class="am-margin-sm more-block">
                <img src="<%= ConfigurationManager.AppSettings["imgUrl"] %>ftp/20191111/more_01m.png" style="width: 100%" />
            </div>
        </section>
    ...
    <script>
        ...
        function DoDel(ItemID) {
            ...
            if (memberID !== '') {
                ...
                $.ajax({
                    type: "post",
                    url: "../user/20191111preorder.aspx/DoDel",
                    data: val,
                ...
                location.href = 'login.aspx?rurl=20191111preorder.aspx';
        ...
        function AddEvent(iid, pid, qty) {
            ...
            if (iid !== "") {
                ...
                $.ajax({
                    type: "post",
                    url: "../user/20191111preorder.aspx/DoAdd",
                    data: val,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
        ...
        function AddOneItem(itemID) {
            ...
            $.ajax({
                type: "post",
                url: "../user/20191111preorder.aspx/GetItem",
                data: val,
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function GetList() {
            ...
            $.ajax({
                type: "post",
                url: "../user/20191111preorder.aspx/GetAddList",
                data: LG,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,

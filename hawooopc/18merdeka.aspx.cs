...
public partial class user_18merdeka : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["desktop"] == null)
            {
                if (ismobile)
                {
                    ...
                    string url = "location.href='../mobile/18merdeka.aspx" + get + "'";
            ...
            if(did==2)
            {
                img1.Src = "https://www.hawooo.com/images/ftp/20180814/edm_04.png";
                img2.Src = "https://www.hawooo.com/images/ftp/20180814/edm_05.png";
            }
            c = bindDT();
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "setClass", "opacityImg(" + did + "," + c + ");", true);
        }
    }
    private int did = 1;
    private int bindDT()
    {
        ...
        switch (did)
        {
            case 1: //限量超值組合
                {
                    ...
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=518) ";
            ...
            case 2: //戴美妝旅行去
                {
                    //lit_title.Text = "保健食品 ";
                    strCmd = "AND WP01 IN (SELECT SPD02 FROM SPRODUCTSD WHERE SPD01=519) ";
                    //imgM.Src = "https://www.hawooo.com/images/ftp/newarivls-week2/edm_01.png";

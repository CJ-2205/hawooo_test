<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/mobile.master" AutoEventWireup="true" CodeFile="2019womenbuy.aspx.cs" Inherits="mobile_2019womenbuy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        ...
        .am-nav-tabs > li.am-active > a {
            background-color: #BA2A31 !important;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: black; position: relative">
        <a href="#" id="coupon1" data-clipboard-text="couponcode" onclick="Clip('coupon1');">
            <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190305/h_03.png" %>' style="float: left; display: block; width: 100%;" /></a>
    ...
    <!--第0塊商品-->
    <div class="am-cf" style="width: 100%; margin: 0 auto; display: block; max-width: 650px; background-color: #BA2A31" id="bc">



        <ul class="am-tabs-nav am-nav am-nav-tabs am-avg-md-4">
            <li id="tab1">
                <a href="2019womenbuy.aspx?did=1">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190305/icon_01t.png" %>' width="100%" />
                </a>

            </li>
            <li id="tab2">
                <a href="2019womenbuy.aspx?did=2">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190305/icon_04t.png" %>' width="100%" />
                </a>

            </li>
            <li id="tab3">
                <a href="2019womenbuy.aspx?did=3">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190305/icon_02t.png" %>' width="100%" />
                </a>

            </li>
            <li id="tab4">
                <a href="2019womenbuy.aspx?did=4">
                    <img src='<%=ConfigurationManager.AppSettings["imgUrl"] +"ftp/20190305/icon_03t.png" %>' width="100%" />
                </a>
            </li>

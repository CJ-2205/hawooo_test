...
public partial class user_static_0302womens_day_hot_deal : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        bool ismobile = PbClass.IsMobile();
        if (ismobile)
            Response.Redirect("../mobile/0302womens_day_hot_deal.aspx" + Request.Url.Query);
        ...
        {
            img.Src = ConfigurationManager.AppSettings["imgUrl"] + "ftp/20200302/bbn_02.png";
